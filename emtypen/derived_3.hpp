...
private:
	...
	friend inline bool check(%struct_name%<___1___, ___2___, ___3___> const& value) noexcept;
...
template <typename ___TTT___, typename ___1___, typename ___2___, typename ___3___>
inline bool check(%struct_name%<___1___, ___2___, ___3___> const& value) noexcept
{
	return ___TTT___::___check___(value.handle_);
}

template <typename ___1___, typename ___2___, typename ___3___>
bool const %struct_name%<___1___, ___2___, ___3___>::___share___ = []()
{
	auto& shoal = shared();
