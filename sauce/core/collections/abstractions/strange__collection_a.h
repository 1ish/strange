...
namespace strange
{
		...
		any_o
	{
		...
		var<range_a<>> (*any_range) (con<collection_a<key_d, value_d, element_d>> const& me);
		...
		var<collection_a<>> (*any_collection) (con<collection_a<key_d, value_d, element_d>> const& me);
