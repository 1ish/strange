...
namespace strange
{
		...
		collection_o<key_d, value_d, var<tuple_a<key_d, value_d>>>
	{
		...
		bit<bidirectional_mutator_a<std::pair<key_d, value_d>>> (*pair_mutator_begin) (var<ordered_table_a<key_d, value_d>> const& me);

		bit<bidirectional_mutator_a<std::pair<key_d, value_d>>> (*pair_mutator_end) (var<ordered_table_a<key_d, value_d>> const& me);
	};
