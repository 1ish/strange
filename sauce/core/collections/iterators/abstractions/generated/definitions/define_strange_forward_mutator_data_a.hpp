...
public:
	inline bool operator==(forward_mutator_data_a < _element , _type > const & it ) const
	{ throw dis(__FILE__, __LINE__, "dynamic forward_mutator_data_d::operator==(it) not available"); }

	inline bool operator!=(forward_mutator_data_a < _element , _type > const & it ) const
	{ throw dis(__FILE__, __LINE__, "dynamic forward_mutator_data_d::operator!=(it) not available"); }

	inline _type const & extract_it() const
	{ throw dis(__FILE__, __LINE__, "dynamic forward_mutator_data_d::extract_it() not available"); }

	inline _type & mutate_it()
	{ throw dis(__FILE__, __LINE__, "dynamic forward_mutator_data_d::mutate_it() not available"); }
