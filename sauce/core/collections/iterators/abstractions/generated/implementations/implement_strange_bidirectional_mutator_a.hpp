...
{
	static cat_a<> CAT = cat::create(1, "strange::bidirectional_mutator", flock::create_vals(kind::create(2, "")));
	return CAT;
}
...
inline unordered_shoal_a<> bidirectional_mutator_a<_element>::___operations___()
{
	static unordered_shoal_a<> OPERATIONS = []()
	{
		...
		operations.update(sym("decrement_"), native_mutation::create(&bidirectional_mutator_a::decrement__));
		return operations;
	}();
	return OPERATIONS;
}
