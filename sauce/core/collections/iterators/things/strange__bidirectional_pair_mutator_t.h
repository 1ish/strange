#ifndef COM_ONEISH__STRANGE__BIDIRECTIONAL_PAIR_MUTATOR_T_H
#define COM_ONEISH__STRANGE__BIDIRECTIONAL_PAIR_MUTATOR_T_H

namespace strange
{
	template <typename iterator_d, typename key_d, typename value_d>
	struct bidirectional_pair_mutator_t : forward_pair_mutator_t<iterator_d, key_d, value_d>
	{
		using element_d = std::pair<key_d const, value_d>;

	protected:
		inline bidirectional_pair_mutator_t(any_a const& me)
			: forward_pair_mutator_t<iterator_d, key_d, value_d>{ me }
		{
			me.o = bidirectional_pair_mutator_t<iterator_d, key_d, value_d>::_operations();
		}

		inline bidirectional_pair_mutator_t(any_a const& me,
			iterator_d const& iterator)
			: forward_pair_mutator_t<iterator_d, key_d, value_d>{ me, iterator }
		{
			me.o = bidirectional_pair_mutator_t<iterator_d, key_d, value_d>::_operations();
		}
		...
		inline bidirectional_pair_mutator_t(any_a const& me,
			...
			: forward_pair_mutator_t<iterator_d, key_d, value_d>{ me, original }
		{
			me.o = bidirectional_pair_mutator_t<iterator_d, key_d, value_d>::_operations();
		}

		bidirectional_pair_mutator_t(bidirectional_pair_mutator_t const&) = delete;
		bidirectional_pair_mutator_t& operator=(bidirectional_pair_mutator_t const&) = delete;
	...
	public:
		...
		{
			any_a r;
			new bidirectional_pair_mutator_t<iterator_d, key_d, value_d>{ r };
			bidirectional_pair_mutator_t<iterator_d, key_d, value_d>::_initialise(reinterpret_cast<var<> const&>(r));
		...
		{
			any_a r;
			new bidirectional_pair_mutator_t<iterator_d, key_d, value_d>{ r, iterator };
			bidirectional_pair_mutator_t<iterator_d, key_d, value_d>::_initialise(reinterpret_cast<var<> const&>(r));
			return bit<bidirectional_mutator_a<element_d>>{ reinterpret_cast<bidirectional_mutator_a<element_d>&>(r) };
		}
