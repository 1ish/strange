...
namespace strange
{
		...
		con<symbol_a> const& function)
	{
		if (scope == "strange")
		{
			if (thing == "bidirectional_mutator_range")
			{
	...
	// instantiation
	template struct bidirectional_mutator_range_a<>;
	template struct bidirectional_mutator_range_a<int64_t>;
	template struct bidirectional_mutator_range_a<uint8_t>;
	template struct bidirectional_mutator_range_a<std::pair<int64_t const, int64_t>>;
}
