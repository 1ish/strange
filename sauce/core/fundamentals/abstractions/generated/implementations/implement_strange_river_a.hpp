...
template <typename _1>
inline std_vector < int8_t > river_a<_1>::get_line(int64_t count , int8_t delimiter )
{ assert(any_a<>::___handle___); return ___write___().get_line(count, delimiter); }

template <typename _1>
template <typename ___TTT___, typename ___DHB___>
inline std_vector < int8_t > river_a<_1>::___river_a_handle___<___TTT___, ___DHB___>::get_line(int64_t count , int8_t delimiter )
...
template <typename _1>
inline std_vector < int8_t > river_a<_1>::read(int64_t count )
{ assert(any_a<>::___handle___); return ___write___().read(count); }

template <typename _1>
template <typename ___TTT___, typename ___DHB___>
inline std_vector < int8_t > river_a<_1>::___river_a_handle___<___TTT___, ___DHB___>::read(int64_t count )
...
template <typename _1>
inline void river_a<_1>::write(std_vector < int8_t > const & lake )
{ assert(any_a<>::___handle___); ___write___().write(lake); }

template <typename _1>
template <typename ___TTT___, typename ___DHB___>
inline void river_a<_1>::___river_a_handle___<___TTT___, ___DHB___>::write(std_vector < int8_t > const & lake )
...
template <typename _1>
inline unordered_herd_a<> river_a<_1>::___cats___()
{
	static unordered_herd_a<> CATS = []()
	{
		auto cats = range_a< any_a<> >::___cats___();
...
template <typename _1>
inline unordered_herd_a<> river_a<_1>::___kinds___()
{
	static unordered_herd_a<> KINDS = []()
	{
		auto kinds = range_a< any_a<> >::___kinds___();
...
template <typename _1>
inline unordered_shoal_a<> river_a<_1>::___operations___()
{
	static unordered_shoal_a<> OPERATIONS = []()
	{
		unordered_shoal_a<> operations = range_a< any_a<> >::___operations___();
		operations.update(sym("to_lake_"), native_mutation::create(&river_a::to_lake__));
		operations.update(sym("get_char_"), native_mutation::create(&river_a::get_char__));
		operations.update(sym("peek_char_"), native_mutation::create(&river_a::peek_char__));
		operations.update(sym("unget_char_"), native_mutation::create(&river_a::unget_char__));
		operations.update(sym("put_back_char_"), native_mutation::create(&river_a::put_back_char__));
		operations.update(sym("get_line_"), native_mutation::create(&river_a::get_line__));
		operations.update(sym("ignore_"), native_mutation::create(&river_a::ignore__));
		operations.update(sym("read_"), native_mutation::create(&river_a::read__));
		operations.update(sym("tellg_"), native_extraction::create(&river_a::tellg__));
		operations.update(sym("seekg_beg_"), native_mutation::create(&river_a::seekg_beg__));
		operations.update(sym("seekg_end_"), native_mutation::create(&river_a::seekg_end__));
		operations.update(sym("seekg_cur_"), native_mutation::create(&river_a::seekg_cur__));
		operations.update(sym("sync_"), native_mutation::create(&river_a::sync__));
		operations.update(sym("put_char_"), native_mutation::create(&river_a::put_char__));
		operations.update(sym("write_"), native_mutation::create(&river_a::write__));
		operations.update(sym("tellp_"), native_extraction::create(&river_a::tellp__));
		operations.update(sym("seekp_beg_"), native_mutation::create(&river_a::seekp_beg__));
		operations.update(sym("seekp_end_"), native_mutation::create(&river_a::seekp_end__));
		operations.update(sym("seekp_cur_"), native_mutation::create(&river_a::seekp_cur__));
		operations.update(sym("flush_"), native_mutation::create(&river_a::flush__));
		operations.update(sym("good_"), native_extraction::create(&river_a::good__));
		operations.update(sym("eof_"), native_extraction::create(&river_a::eof__));
		operations.update(sym("fail_"), native_extraction::create(&river_a::fail__));
		operations.update(sym("bad_"), native_extraction::create(&river_a::bad__));
		operations.update(sym("set_good_"), native_mutation::create(&river_a::set_good__));
		operations.update(sym("set_eof_"), native_mutation::create(&river_a::set_eof__));
		operations.update(sym("set_fail_"), native_mutation::create(&river_a::set_fail__));
		operations.update(sym("set_bad_"), native_mutation::create(&river_a::set_bad__));
		operations.update(sym("filename_"), native_extraction::create(&river_a::filename__));
		operations.update(sym("close_"), native_mutation::create(&river_a::close__));
		operations.update(sym("closed_"), native_extraction::create(&river_a::closed__));
		return operations;
	}();
	return OPERATIONS;
}
