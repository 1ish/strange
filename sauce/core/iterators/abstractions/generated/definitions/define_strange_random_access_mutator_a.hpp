...
private:
	...
	struct ___random_access_mutator_a_handle_final___ final : ___random_access_mutator_a_handle___<___TTT___>
	{
		...
		{
			return std_make_shared<___random_access_mutator_a_handle_final___>(___random_access_mutator_a_handle___<___TTT___>::___value___);
		}
	};
...
public:
	...
	explicit inline random_access_mutator_a(___TTT___ value) noexcept
		: bidirectional_mutator_a< _element >{ std_make_shared<___random_access_mutator_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	explicit inline random_access_mutator_a(any_a<>::___variadic_tag___, ___TTT___*, Args&&... args)
		: bidirectional_mutator_a< _element >{ std_make_shared<___random_access_mutator_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
...
public:
	inline any_a<> self_add__(list_a<> const& arguments)
	{
		...
		if (!op)
		{
			throw dis(__FILE__, __LINE__, "dynamic random_access_mutator_d::self_add_ passed non-existent member");
		}
	...
	inline any_a<> add__(list_a<> const& arguments) const
	{
		...
		if (!op)
		{
			throw dis(__FILE__, __LINE__, "dynamic random_access_mutator_d::add_ passed non-existent member");
		}
	...
	inline any_a<> self_subtract__(list_a<> const& arguments)
	{
		...
		if (!op)
		{
			throw dis(__FILE__, __LINE__, "dynamic random_access_mutator_d::self_subtract_ passed non-existent member");
		}
		return op.operate(*this, arguments);
	}
	...
	inline any_a<> subtract__(list_a<> const& arguments) const
	{
		...
		if (!op)
		{
			throw dis(__FILE__, __LINE__, "dynamic random_access_mutator_d::subtract_ passed non-existent member");
		}
		return op.operate(*const_cast<random_access_mutator_d*>(this), arguments);
	}
