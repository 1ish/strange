...
public:
	inline bool operator==(random_access_mutator_data_a < _element , _type > const & it ) const
	{ throw dis(__FILE__, __LINE__, "dynamic random_access_mutator_data_d::operator==(it) not available"); }
	...
	inline _type const & extract_it() const
	{ throw dis(__FILE__, __LINE__, "dynamic random_access_mutator_data_d::extract_it() not available"); }

	inline _type & mutate_it()
	{ throw dis(__FILE__, __LINE__, "dynamic random_access_mutator_data_d::mutate_it() not available"); }
