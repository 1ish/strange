...
protected:
	struct ___any_a_handle_base___
	{
		...
		virtual inline any_a<> shared__(range_a const& range) const = 0;
		virtual inline unordered_shoal_a shared_() const = 0;
		virtual inline void share(shoal_a & shoal ) const = 0;
		virtual inline any_a<> cat__(range_a const& range) const = 0;
		virtual inline cat_a cat_() const = 0;
		virtual inline any_a<> cats__(range_a const& range) const = 0;
		virtual inline unordered_herd_a cats_() const = 0;
		virtual inline any_a<> kind__(range_a const& range) const = 0;
		virtual inline kind_a kind_() const = 0;
		virtual inline any_a<> kinds__(range_a const& range) const = 0;
		virtual inline unordered_herd_a kinds_() const = 0;
		virtual inline any_a<> operations__(range_a const& range) const = 0;
		...
		virtual inline any_a<> identity__(range_a const& range) const = 0;
		...
		virtual inline any_a<> nothing__(range_a const& range) const = 0;
		virtual inline any_a<> nothing_() const = 0;
		virtual inline bool nothing() const = 0;
		virtual inline any_a<> something__(range_a const& range) const = 0;
		...
		virtual inline bool operator!=(any_a < > const & thing ) const = 0;
		virtual inline any_a<> hash__(range_a const& range) const = 0;
