...
public:
	...
	explicit inline bidirectional_const_iterator_a(std::shared_ptr<___bidirectional_const_iterator_a_handle_base___> const& handle) noexcept
		: forward_const_iterator_a{ handle }
	{}

	explicit inline bidirectional_const_iterator_a(std::shared_ptr<___bidirectional_const_iterator_a_handle_base___>& handle, ___reference_tag___) noexcept
