...
inline bool check(bidirectional_const_iterator_a<_1_> const& value) noexcept;
...
private:
	...
	friend inline bool check(bidirectional_const_iterator_a<_1_> const& value) noexcept;
