...
public:
	...
	explicit inline bidirectional_const_iterator_data_a(___variadic_tag___, Args&&... args)
		: bidirectional_const_iterator_a{ std::make_shared<___bidirectional_const_iterator_data_a_handle_final___<typename std::remove_reference<___TTT___>::type>>(___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		___handle___->___weak___(___handle___);
	}
