...
protected:
	...
	struct ___bidirectional_const_iterator_data_a_handle___ : ___bidirectional_const_iterator_a_handle___<___TTT___, ___DHB___>
	{
		...
		inline ___bidirectional_const_iterator_data_a_handle___(___variadic_tag___, Args&&... args)
			: ___bidirectional_const_iterator_a_handle___<___TTT___, ___DHB___>(___variadic_tag___{}, std::forward<Args>(args)...)
		{}
...
private:
	...
	struct ___bidirectional_const_iterator_data_a_handle_final___ final : ___bidirectional_const_iterator_data_a_handle___<___TTT___>
	{
		...
		template <typename... Args>
		inline ___bidirectional_const_iterator_data_a_handle_final___(___variadic_tag___, Args&&... args)
			: ___bidirectional_const_iterator_data_a_handle___<___TTT___>(___variadic_tag___{}, std::forward<Args>(args)...)
		{}

		virtual inline ___SHARED___ ___clone___() const final
		{
			return std::make_shared<___bidirectional_const_iterator_data_a_handle_final___>(___bidirectional_const_iterator_data_a_handle___<___TTT___>::___value___);
		}
	};
...
protected:
	inline ___bidirectional_const_iterator_data_a_handle_base___ const& ___read___() const noexcept
	{
		return *std::static_pointer_cast<___bidirectional_const_iterator_data_a_handle_base___ const>(___handle___);
	}

	inline ___bidirectional_const_iterator_data_a_handle_base___& ___write___() noexcept
	{
		...
		return *std::static_pointer_cast<___bidirectional_const_iterator_data_a_handle_base___>(___handle___);
	}
...
public:
	...
	explicit inline bidirectional_const_iterator_data_a(___TTT___ value) noexcept
		: bidirectional_const_iterator_a{ std::make_shared<___bidirectional_const_iterator_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		___handle___->___weak___(___handle___);
	}

	template <typename ___TTT___, typename... Args>
	explicit inline bidirectional_const_iterator_data_a(___variadic_tag___, ___TTT___*, Args&&... args)
		: bidirectional_const_iterator_a{ std::make_shared<___bidirectional_const_iterator_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		___handle___->___weak___(___handle___);
	}
	...
	{
		return bool{ std::dynamic_pointer_cast<___bidirectional_const_iterator_data_a_handle_base___>(thing.___handle___) };
	}

	static inline bidirectional_const_iterator_data_a ___cast___(any_a<> const& thing)
	{
		auto const ptr = std::dynamic_pointer_cast<___bidirectional_const_iterator_data_a_handle_base___>(thing.___handle___);
		if (ptr)
		{
			return bidirectional_const_iterator_data_a{ thing.___handle___ };
		}
		return bidirectional_const_iterator_data_a{ bidirectional_const_iterator_data_d<_1_>{ thing } };
	}

	static inline bidirectional_const_iterator_data_a ___cast_ref___(any_a<>& thing)
	{
		auto const ptr = std::dynamic_pointer_cast<___bidirectional_const_iterator_data_a_handle_base___>(thing.___handle___);
		if (ptr)
		{
			return bidirectional_const_iterator_data_a(thing.___handle___, ___reference_tag___{});
		}
		return bidirectional_const_iterator_data_a{ bidirectional_const_iterator_data_d<_1_>(thing, ___reference_tag___{}) };
	}

	template <typename ___cat_a___ = cat_a<>, typename ___kind_a___ = kind_a<>>
	static inline ___cat_a___ ___cat___()
	{
		static ___cat_a___ CAT = cat_create<___cat_a___>(1, "strange::bidirectional_const_iterator_data", flock_vals(kind_create<___kind_a___>(2, "")));
		return CAT;
	}
	...
	static inline ___unordered_herd_a___ ___cats___()
	{
		...
		{
			auto cats = bidirectional_const_iterator_a::___cats___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
	...
	static inline ___unordered_herd_a___ ___kinds___()
	{
		...
		{
			auto kinds = bidirectional_const_iterator_a::___kinds___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
	...
	static inline ___unordered_shoal_a___ ___operations___()
	{
		...
		{
			___unordered_shoal_a___ operations = bidirectional_const_iterator_a::___operations___<___unordered_shoal_a___>();
			return operations;
		}();
		return OPERATIONS;
	}
	...
	template <typename ___TTT___, typename... Args>
	static inline bidirectional_const_iterator_data_a create(Args&&... args)
	{
		return bidirectional_const_iterator_data_a(___variadic_tag___{}, static_cast<___TTT___*>(nullptr), std::forward<Args>(args)...);
	}
...
public:
	...
	explicit bidirectional_const_iterator_data_d(any_a<>& thing, ___reference_tag___)
		: bidirectional_const_iterator_d<>{ thing, ___reference_tag___{} }
	{}

	explicit bidirectional_const_iterator_data_d(any_a<>& thing, ___duplicate_tag___)
		: bidirectional_const_iterator_d<>{ thing, ___duplicate_tag___{} }
	{}
};
