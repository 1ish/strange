...
public:
	...
	explicit inline bidirectional_const_iterator_data_a(std::shared_ptr<___bidirectional_const_iterator_data_a_handle_base___> const& handle) noexcept
		: bidirectional_const_iterator_a{ handle }
	{}

	explicit inline bidirectional_const_iterator_data_a(std::shared_ptr<___bidirectional_const_iterator_data_a_handle_base___>& handle, ___reference_tag___) noexcept
...
*/
	...
	static inline bidirectional_const_iterator_data_a ___cast___(any_a<> const& thing)
	{
		...
		if (ptr)
		{
			return bidirectional_const_iterator_data_a{ ptr };
		}
	...
	static inline bidirectional_const_iterator_data_a ___cast_ref___(any_a<>& thing)
	{
		...
		if (ptr)
		{
			return bidirectional_const_iterator_data_a(ptr, ___reference_tag___{});
		}
