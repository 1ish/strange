...
private:
	...
	struct ___bidirectional_extractor_a_handle_final___ final : ___bidirectional_extractor_a_handle___<___TTT___>
	{
		...
		virtual inline forward_extractor_a< any_a<> >::template ___SHARED___ ___clone___() const final
		{
...
public:
	...
	void ___weak___(forward_extractor_d< any_a<> >::template ___WEAK___ const& weak) const {}
