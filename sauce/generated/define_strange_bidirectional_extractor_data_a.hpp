...
template <typename _1_>
inline bidirectional_extractor_data_d<_1_> ___bidirectional_extractor_data_dynamic___(any_a<> const& thing); 

template <typename _1_>
class bidirectional_extractor_data_a : public bidirectional_extractor_a<>
{
public:
	inline bool operator==(bidirectional_extractor_data_a < _1_ > const & it ) const
...
protected:
	struct ___bidirectional_extractor_data_a_handle_base___ : ___bidirectional_extractor_a_handle_base___
	{
		virtual bool operator==(bidirectional_extractor_data_a < _1_ > const & it ) const = 0;
		virtual bool operator!=(bidirectional_extractor_data_a < _1_ > const & it ) const = 0;
	...
	struct ___bidirectional_extractor_data_a_handle___ : ___bidirectional_extractor_a_handle___<___TTT___, ___DHB___>
	{
		...
		inline ___bidirectional_extractor_data_a_handle___(___variadic_tag___, Args&&... args)
			: ___bidirectional_extractor_a_handle___<___TTT___, ___DHB___>(___variadic_tag___{}, std::forward<Args>(args)...)
		{}

		virtual inline bool operator==(bidirectional_extractor_data_a < _1_ > const & it ) const final
...
private:
	...
	struct ___bidirectional_extractor_data_a_handle_final___ final : ___bidirectional_extractor_data_a_handle___<___TTT___>
	{
		...
		template <typename... Args>
		inline ___bidirectional_extractor_data_a_handle_final___(___variadic_tag___, Args&&... args)
			: ___bidirectional_extractor_data_a_handle___<___TTT___>(___variadic_tag___{}, std::forward<Args>(args)...)
		{}
...
protected:
	...
	{
		return *std::static_pointer_cast<___bidirectional_extractor_data_a_handle_base___ const>(___handle___);
	}
	...
	inline ___bidirectional_extractor_data_a_handle_base___& ___write___() noexcept
	{
		...
		return *std::static_pointer_cast<___bidirectional_extractor_data_a_handle_base___>(___handle___);
	}
...
public:
	...
	{
		return bidirectional_extractor_data_a(other, ___reference_tag___{});
	}

	static inline bidirectional_extractor_data_a dup(bidirectional_extractor_data_a& other) noexcept
	{
		return bidirectional_extractor_data_a(other, ___duplicate_tag___{});
	}

	inline bidirectional_extractor_data_a() = default;

	inline bidirectional_extractor_data_a(bidirectional_extractor_data_a& other, ___reference_tag___) noexcept
		: bidirectional_extractor_a(other, ___reference_tag___{})
	{}

	inline bidirectional_extractor_data_a(bidirectional_extractor_data_a& other, ___duplicate_tag___) noexcept
	...
	template <typename ___TTT___>
	explicit inline bidirectional_extractor_data_a(std::shared_ptr<___TTT___>& handle, ___reference_tag___) noexcept
	...
	explicit inline bidirectional_extractor_data_a(___variadic_tag___, ___TTT___*, Args&&... args)
		: bidirectional_extractor_a{ std::make_shared<___bidirectional_extractor_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		___handle___->___weak___(___handle___);
	}
	...
	static inline bidirectional_extractor_data_a ___cast___(any_a<> const& thing)
	{
		...
		return bidirectional_extractor_data_a{ bidirectional_extractor_data_d<_1_>{ thing } };
	}
	...
	static inline bidirectional_extractor_data_a ___cast_ref___(any_a<>& thing)
	{
		...
		if (ptr)
		{
			return bidirectional_extractor_data_a(thing.___handle___, ___reference_tag___{});
		}
		return bidirectional_extractor_data_a{ bidirectional_extractor_data_d<_1_>(thing, ___reference_tag___{}) };
	}
	...
	{
		return bidirectional_extractor_data_a(___variadic_tag___{}, static_cast<___TTT___*>(nullptr), std::forward<Args>(args)...);
	}

private:
	static bool const ___share___;
	friend class ___bidirectional_extractor_data_a_share___;
...
public:
	...
	explicit bidirectional_extractor_data_d(any_a<>& thing, ___reference_tag___)
		: bidirectional_extractor_d<>{ thing, ___reference_tag___{} }
	{}

	explicit bidirectional_extractor_data_d(any_a<>& thing, ___duplicate_tag___)
