...
{
public:
	inline bool operator==(bidirectional_extractor_data_a < _element , _type > const & it ) const;
...
protected:
	struct ___bidirectional_extractor_data_a_handle_base___ : bidirectional_extractor_a< _element >::___bidirectional_extractor_a_handle_base___
	{
		virtual bool operator==(bidirectional_extractor_data_a < _element , _type > const & it ) const = 0;
		virtual bool operator!=(bidirectional_extractor_data_a < _element , _type > const & it ) const = 0;
	...
	struct ___bidirectional_extractor_data_a_handle___ : bidirectional_extractor_a< _element >::template ___bidirectional_extractor_a_handle___<___TTT___, ___DHB___>
	{
		template <typename ___UUU___ = ___TTT___>
		inline ___bidirectional_extractor_data_a_handle___(___TTT___ value, typename std_enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: bidirectional_extractor_a< _element >::template ___bidirectional_extractor_a_handle___<___TTT___, ___DHB___>{ value }
		{}

		template <typename ___UUU___ = ___TTT___>
		inline ___bidirectional_extractor_data_a_handle___(___TTT___ value, typename std_enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
		...
		virtual inline bool operator==(bidirectional_extractor_data_a < _element , _type > const & it ) const final;
...
private:
	...
	{
		template <typename ___UUU___ = ___TTT___>
		inline ___bidirectional_extractor_data_a_handle_final___(___TTT___ value, typename std_enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: ___bidirectional_extractor_data_a_handle___<___TTT___>{ value }
		{}

		template <typename ___UUU___ = ___TTT___>
		inline ___bidirectional_extractor_data_a_handle_final___(___TTT___ value, typename std_enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
...
public:
	...
	template <typename ___TTT___>
	explicit inline bidirectional_extractor_data_a(std_shared_ptr<___TTT___> const& handle) noexcept
	...
	template <typename ___TTT___>
	explicit inline bidirectional_extractor_data_a(std_shared_ptr<___TTT___>& handle, any_a<>::___reference_tag___) noexcept
		: bidirectional_extractor_a< _element >(handle, any_a<>::___reference_tag___{})
	{
		assert(!handle || std::dynamic_pointer_cast<___bidirectional_extractor_data_a_handle_base___>(handle));
	}

	template <typename ___TTT___, typename = typename std_enable_if_t<!std::is_base_of<bidirectional_extractor_data_a, std::decay_t<___TTT___>>::value>>
	explicit inline bidirectional_extractor_data_a(___TTT___ value) noexcept
		: bidirectional_extractor_a< _element >{ std::make_shared<___bidirectional_extractor_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	explicit inline bidirectional_extractor_data_a(any_a<>::___variadic_tag___, ___TTT___*, Args&&... args)
		: bidirectional_extractor_a< _element >{ std::make_shared<___bidirectional_extractor_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}

	template <typename ___TTT___>
	inline bidirectional_extractor_data_a& operator=(std_shared_ptr<___TTT___> const& handle) noexcept
	{
		assert(!handle || std::dynamic_pointer_cast<___bidirectional_extractor_data_a_handle_base___>(handle));
	...
	static inline bidirectional_extractor_data_a ___cast___(any_a<> const& thing)
	{
		...
		return bidirectional_extractor_data_a{ bidirectional_extractor_data_d<_element, _type>{ thing } };
	}
	...
	static inline bidirectional_extractor_data_a ___cast_ref___(any_a<>& thing)
	{
		...
		return bidirectional_extractor_data_a{ bidirectional_extractor_data_d<_element, _type>(thing, any_a<>::___reference_tag___{}) };
	}

	template <typename ___cat_a___ = cat_a<>, typename ___kind_a___ = kind_a<>>
	static inline ___cat_a___ ___cat___()
	{
		static ___cat_a___ CAT = cat_create<___cat_a___>(1, "strange::bidirectional_extractor_data", flock_vals(kind_create<___kind_a___>(2, ""), kind_create<___kind_a___>(2, "")));
		return CAT;
	}
...
template <typename _element, typename _type>
class bidirectional_extractor_data_d : public bidirectional_extractor_d< _element >
{
public:
	inline bool operator==(bidirectional_extractor_data_a < _element , _type > const & it ) const
