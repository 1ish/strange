...
private:
	...
	struct ___bidirectional_extractor_data_a_handle_final___ final : ___bidirectional_extractor_data_a_handle___<___TTT___>
	{
		...
		{
			return std_make_shared<___bidirectional_extractor_data_a_handle_final___>(___bidirectional_extractor_data_a_handle___<___TTT___>::___value___);
		}
	};
...
public:
	...
	explicit inline bidirectional_extractor_data_a(___TTT___ value) noexcept
		: bidirectional_extractor_a< _element >{ std_make_shared<___bidirectional_extractor_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	explicit inline bidirectional_extractor_data_a(any_a<>::___variadic_tag___, ___TTT___*, Args&&... args)
		: bidirectional_extractor_a< _element >{ std_make_shared<___bidirectional_extractor_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
...
public:
	inline bool operator==(bidirectional_extractor_data_a < _element , _type > const & it ) const
	{ throw dis(__FILE__, __LINE__, "dynamic bidirectional_extractor_data_d::operator==(it) not available"); }

	inline bool operator!=(bidirectional_extractor_data_a < _element , _type > const & it ) const
	{ throw dis(__FILE__, __LINE__, "dynamic bidirectional_extractor_data_d::operator!=(it) not available"); }

	inline _type const & extract_it() const
	{ throw dis(__FILE__, __LINE__, "dynamic bidirectional_extractor_data_d::extract_it() not available"); }

	inline _type & mutate_it()
	{ throw dis(__FILE__, __LINE__, "dynamic bidirectional_extractor_data_d::mutate_it() not available"); }
