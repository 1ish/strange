...
public:
	...
	explicit inline bidirectional_iterator_a(std::shared_ptr<___bidirectional_iterator_a_handle_base___> const& handle) noexcept
		: forward_iterator_a{ handle }
	{}

	explicit inline bidirectional_iterator_a(std::shared_ptr<___bidirectional_iterator_a_handle_base___>& handle, ___reference_tag___) noexcept
...
*/
	...
	static inline bidirectional_iterator_a ___cast_ref___(any_a<>& thing)
	{
		...
		if (ptr)
		{
			return bidirectional_iterator_a(ptr, ___reference_tag___{});
		}
