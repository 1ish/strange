...
protected:
	...
	struct ___bidirectional_iterator_a_handle___ : ___forward_iterator_a_handle___<___TTT___, ___DHB___>
	{
		...
		inline ___bidirectional_iterator_a_handle___(___variadic_tag___, Args&&... args)
...
private:
	...
	struct ___bidirectional_iterator_a_handle_final___ final : ___bidirectional_iterator_a_handle___<___TTT___>
	{
		...
		template <typename... Args>
		inline ___bidirectional_iterator_a_handle_final___(___variadic_tag___, Args&&... args)
			: ___bidirectional_iterator_a_handle___<___TTT___>(___variadic_tag___{}, std::forward<Args>(args)...)
		{}
...
protected:
	inline ___bidirectional_iterator_a_handle_base___ const& ___read___() const noexcept
	{
		return *std::static_pointer_cast<___bidirectional_iterator_a_handle_base___ const>(___handle___);
	}

	inline ___bidirectional_iterator_a_handle_base___& ___write___() noexcept
	{
...
public:
	...
	explicit inline bidirectional_iterator_a(___TTT___ value) noexcept
		: forward_iterator_a{ std::make_shared<___bidirectional_iterator_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		___handle___->___weak___(___handle___);
	}

	template <typename ___TTT___, typename... Args>
	explicit inline bidirectional_iterator_a(___variadic_tag___, ___TTT___*, Args&&... args)
		: forward_iterator_a{ std::make_shared<___bidirectional_iterator_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		___handle___->___weak___(___handle___);
	}
	...
	static inline bidirectional_iterator_a ___cast___(any_a<> const& thing)
	{
		...
		if (ptr)
		{
			return bidirectional_iterator_a{ thing.___handle___ };
		}
		return bidirectional_iterator_a{ bidirectional_iterator_d<_1_>{ thing } };
	}

	static inline bidirectional_iterator_a ___cast_ref___(any_a<>& thing)
	{
		auto const ptr = std::dynamic_pointer_cast<___bidirectional_iterator_a_handle_base___>(thing.___handle___);
		if (ptr)
		{
			return bidirectional_iterator_a(thing.___handle___, ___reference_tag___{});
		}
		return bidirectional_iterator_a{ bidirectional_iterator_d<_1_>(thing, ___reference_tag___{}) };
	}

	template <typename ___cat_a___ = cat_a<>, typename ___kind_a___ = kind_a<>>
	static inline ___cat_a___ ___cat___()
	{
		static ___cat_a___ CAT = cat_create<___cat_a___>(1, "strange::bidirectional_iterator");
		return CAT;
	}
	...
	{
		return bidirectional_iterator_a(___variadic_tag___{}, static_cast<___TTT___*>(nullptr), std::forward<Args>(args)...);
	}
...
public:
	...
	inline any_a<> decrement__(range_a<> const& arguments)
	{
		...
		if (!op)
		{
			throw throw_dis("dynamic bidirectional_iterator_d::decrement_ passed non-existent member");
		}
	...
	inline bidirectional_iterator_a<> decrement_()
	{
		...
		return cast<bidirectional_iterator_a<>>(variadic_operate(op, *this));
	}
	...
	explicit bidirectional_iterator_d(any_a<>& thing, ___reference_tag___)
		: forward_iterator_d<>{ thing, ___reference_tag___{} }
	{}

	explicit bidirectional_iterator_d(any_a<>& thing, ___duplicate_tag___)
