...
public:
	...
	static inline bidirectional_iterator_a ___cast_ref___(any_a<> const& thing)
	{
		auto const ptr = std::dynamic_pointer_cast<___bidirectional_iterator_a_handle_base___>(thing.___handle___);
		if (ptr)
		{
	...
	static inline bidirectional_iterator_a ___cast_dup___(any_a<> const& thing)
	{
		auto const ptr = std::dynamic_pointer_cast<___bidirectional_iterator_a_handle_base___>(thing.___handle___);
		if (ptr)
		{
			return bidirectional_iterator_a{ ptr, ___duplicate_tag___{} };
		}
		return bidirectional_iterator_a{ bidirectional_iterator_d<_1_>{ thing, ___duplicate_tag___{} } };
	}
