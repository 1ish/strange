...
public:
	...
	explicit inline bidirectional_iterator_data_a(std::shared_ptr<___bidirectional_iterator_data_a_handle_base___> const& handle) noexcept
		: bidirectional_iterator_a{ handle }
	{}

	explicit inline bidirectional_iterator_data_a(std::shared_ptr<___bidirectional_iterator_data_a_handle_base___>& handle, ___reference_tag___) noexcept
