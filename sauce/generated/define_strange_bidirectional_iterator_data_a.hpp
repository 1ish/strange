...
inline bool check(bidirectional_iterator_data_a<_1_> const& value) noexcept;
...
private:
	...
	inline ___bidirectional_iterator_data_a_handle_base___ const& read() const noexcept
	{
		return *std::static_pointer_cast<___bidirectional_iterator_data_a_handle_base___ const>(handle_);
	}

	inline ___bidirectional_iterator_data_a_handle_base___& write() noexcept
	{
		if (!handle_.unique())
		{
		...
		return *std::static_pointer_cast<___bidirectional_iterator_data_a_handle_base___>(handle_);
	}

	template <typename ___TTT___, typename _1_>
	friend inline bool check(bidirectional_iterator_data_a<_1_> const& value) noexcept;
