...
protected:
	...
	struct ___bidirectional_mutator_data_a_handle___ : bidirectional_mutator_a<>::template ___bidirectional_mutator_a_handle___<___TTT___, ___DHB___>
	{
...
private:
	...
	struct ___bidirectional_mutator_data_a_handle_final___ final : ___bidirectional_mutator_data_a_handle___<___TTT___>
	{
		...
		virtual inline bidirectional_mutator_a<>::template ___SHARED___ ___clone___() const final
		{
...
public:
	...
	template <typename ___TTT___>
	explicit inline bidirectional_mutator_data_a(std::shared_ptr<___TTT___>& handle, any_a<>::___reference_tag___) noexcept
	...
	explicit inline bidirectional_mutator_data_a(any_a<>::___variadic_tag___, ___TTT___*, Args&&... args)
		: bidirectional_mutator_a<>{ std::make_shared<___bidirectional_mutator_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	static inline bidirectional_mutator_data_a ___cast_ref___(any_a<>& thing)
	{
		...
		return bidirectional_mutator_data_a{ bidirectional_mutator_data_d<_type>(thing, any_a<>::___reference_tag___{}) };
	}
...
public:
	...
	void ___weak___(bidirectional_mutator_d<>::template ___WEAK___ const& weak) const {}
