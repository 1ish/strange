...
protected:
	...
	struct ___bidirectional_mutator_data_a_handle___ : ___bidirectional_mutator_a_handle___<___TTT___, ___DHB___>
	{
		template <typename ___UUU___ = ___TTT___>
		inline ___bidirectional_mutator_data_a_handle___(___TTT___ value, typename std::enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: ___bidirectional_mutator_a_handle___<___TTT___, ___DHB___>{ value }
		{}

		template <typename ___UUU___ = ___TTT___>
		inline ___bidirectional_mutator_data_a_handle___(___TTT___ value, typename std::enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
			: ___bidirectional_mutator_a_handle___<___TTT___, ___DHB___>{ std::move(value) }
		{}

		template <typename... Args>
		inline ___bidirectional_mutator_data_a_handle___(___variadic_tag___, Args&&... args)
...
private:
	...
	{
		template <typename ___UUU___ = ___TTT___>
		inline ___bidirectional_mutator_data_a_handle_final___(___TTT___ value, typename std::enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: ___bidirectional_mutator_data_a_handle___<___TTT___>{ value }
		{}

		template <typename ___UUU___ = ___TTT___>
		inline ___bidirectional_mutator_data_a_handle_final___(___TTT___ value, typename std::enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
			: ___bidirectional_mutator_data_a_handle___<___TTT___>{ std::move(value) }
		{}

		template <typename... Args>
		inline ___bidirectional_mutator_data_a_handle_final___(___variadic_tag___, Args&&... args)
			: ___bidirectional_mutator_data_a_handle___<___TTT___>(___variadic_tag___{}, std::forward<Args>(args)...)
		{}
...
protected:
	...
	{
		return *std::static_pointer_cast<___bidirectional_mutator_data_a_handle_base___ const>(___handle___);
	}
	...
	inline ___bidirectional_mutator_data_a_handle_base___& ___write___() noexcept
	{
		...
		return *std::static_pointer_cast<___bidirectional_mutator_data_a_handle_base___>(___handle___);
	}
...
public:
	...
	{
		return bidirectional_mutator_data_a(other, ___reference_tag___{});
	}

	static inline bidirectional_mutator_data_a dup(bidirectional_mutator_data_a& other) noexcept
	{
		return bidirectional_mutator_data_a(other, ___duplicate_tag___{});
	}

	inline bidirectional_mutator_data_a() = default;

	inline bidirectional_mutator_data_a(bidirectional_mutator_data_a& other, ___reference_tag___) noexcept
		: bidirectional_mutator_a(other, ___reference_tag___{})
	{}

	inline bidirectional_mutator_data_a(bidirectional_mutator_data_a& other, ___duplicate_tag___) noexcept
		: bidirectional_mutator_a(other, ___duplicate_tag___{})
	{}

	template <typename ___TTT___>
	explicit inline bidirectional_mutator_data_a(std::shared_ptr<___TTT___> const& handle) noexcept
	...
	template <typename ___TTT___>
	explicit inline bidirectional_mutator_data_a(std::shared_ptr<___TTT___>& handle, ___reference_tag___) noexcept
		: bidirectional_mutator_a(handle, ___reference_tag___{})
	{
		assert(!handle || std::dynamic_pointer_cast<___bidirectional_mutator_data_a_handle_base___>(handle));
	}

	template <typename ___TTT___, typename = typename std::enable_if_t<!std::is_base_of<bidirectional_mutator_data_a, std::decay_t<___TTT___>>::value>>
	explicit inline bidirectional_mutator_data_a(___TTT___ value) noexcept
		: bidirectional_mutator_a{ std::make_shared<___bidirectional_mutator_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		___handle___->___weak___(___handle___);
	}

	template <typename ___TTT___, typename... Args>
	explicit inline bidirectional_mutator_data_a(___variadic_tag___, ___TTT___*, Args&&... args)
		: bidirectional_mutator_a{ std::make_shared<___bidirectional_mutator_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		___handle___->___weak___(___handle___);
	}

	template <typename ___TTT___>
	inline bidirectional_mutator_data_a& operator=(std::shared_ptr<___TTT___> const& handle) noexcept
	{
		assert(!handle || std::dynamic_pointer_cast<___bidirectional_mutator_data_a_handle_base___>(handle));
		___handle___ = handle;
		return *this;
	...
	{
		static ___cat_a___ CAT = cat_create<___cat_a___>(1, "strange::bidirectional_mutator_data", flock_vals(kind_create<___kind_a___>(2, "")));
		return CAT;
	}
	...
	{
		return bidirectional_mutator_data_a(___variadic_tag___{}, static_cast<___TTT___*>(nullptr), std::forward<Args>(args)...);
	}

private:
	static bool const ___share___;
	friend class ___bidirectional_mutator_data_a_share___;
...
public:
	...
	explicit bidirectional_mutator_data_d(any_a<>& thing, ___reference_tag___)
		: bidirectional_mutator_d<>{ thing, ___reference_tag___{} }
	{}

	explicit bidirectional_mutator_data_d(any_a<>& thing, ___duplicate_tag___)
