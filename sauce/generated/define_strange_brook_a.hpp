...
public:
	...
	explicit inline brook_a(std::shared_ptr<___brook_a_handle_base___> const& handle) noexcept
		: inventory_a{ handle }
	{}

	explicit inline brook_a(std::shared_ptr<___brook_a_handle_base___>& handle, ___reference_tag___) noexcept
