...
private:
	...
	struct ___brook_a_handle_final___ final : ___brook_a_handle___<___TTT___>
	{
		...
		{
			return std_make_shared<___brook_a_handle_final___>(___brook_a_handle___<___TTT___>::___value___);
		}
	};
...
public:
	...
	explicit inline brook_a(___TTT___ value) noexcept
		: inventory_a< number_data_a< _primitive > >{ std_make_shared<___brook_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	explicit inline brook_a(any_a<>::___variadic_tag___, ___TTT___*, Args&&... args)
		: inventory_a< number_data_a< _primitive > >{ std_make_shared<___brook_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
