...
inline bool check(cat_a<_1_> const& value) noexcept;
...
protected:
	...
	struct ___cat_a_handle___ : ___symbol_a_handle___<___TTT___, ___DHB___>
	{
		...
		{ return value_.symbolic__(range); }
		...
		{ return value_.parameters__(range); }
...
private:
	...
	friend inline bool check(cat_a<_1_> const& value) noexcept;
