...
public:
	...
	explicit inline data_a(std::shared_ptr<___data_a_handle_base___> const& handle) noexcept
		: any_a{ handle }
	{}

	explicit inline data_a(std::shared_ptr<___data_a_handle_base___>& handle, ___reference_tag___) noexcept
