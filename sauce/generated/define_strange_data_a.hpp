...
protected:
	...
	struct ___data_a_handle___ : ___any_a_handle___<___TTT___, ___DHB___>
	{
		...
		{ return ___any_a_handle___<___TTT___, ___DHB___>::value_.extract_data(); }

		virtual inline _1_ & mutate_data() final
		{ return ___any_a_handle___<___TTT___, ___DHB___>::value_.mutate_data(); }
...
public:
	...
	static inline data_a cast(any_a<> const& thing)
	{
		auto const ptr = std::dynamic_pointer_cast<___data_a_handle_base___>(static_cast<data_a const&>(thing).handle_);
		if (ptr)
		{
			return data_a{ ptr };
		}
