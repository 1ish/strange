...
public:
	...
	{ assert(___handle___); return ___read___().operator==(flock); }
...
protected:
	...
	struct ___flock_a_handle___ : ___inventory_a_handle___<___TTT___, ___DHB___>
	{
		...
		{ return ___any_a_handle___<___TTT___, ___DHB___>::___value___.operator==(flock); }
...
public:
	...
	static inline flock_a ___cast_ref___(any_a<>& thing)
	{
		...
		return flock_a{ flock_d<_1>(thing, ___reference_tag___{}) };
	}
