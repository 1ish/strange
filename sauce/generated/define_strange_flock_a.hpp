...
public:
	...
	explicit inline flock_a(std::shared_ptr<___flock_a_handle_base___> const& handle) noexcept
		: inventory_a{ handle }
	{}

	explicit inline flock_a(std::shared_ptr<___flock_a_handle_base___>& handle, ___reference_tag___) noexcept
