...
inline bool check(forward_const_iterator_data_a<_1_> const& value) noexcept;
...
private:
	...
	template <typename ___TTT___, typename _1_>
	friend inline bool check(forward_const_iterator_data_a<_1_> const& value) noexcept;
