...
public:
	...
	explicit inline forward_const_iterator_data_a(std::shared_ptr<___forward_const_iterator_data_a_handle_base___> const& handle) noexcept
		: forward_const_iterator_a{ handle }
	{}

	explicit inline forward_const_iterator_data_a(std::shared_ptr<___forward_const_iterator_data_a_handle_base___>& handle, ___reference_tag___) noexcept
