...
public:
	...
	static inline forward_const_iterator_data_a cast(any_a<> const& thing)
	{
		auto const ptr = std::dynamic_pointer_cast<___forward_const_iterator_data_a_handle_base___>(static_cast<forward_const_iterator_data_a const&>(thing).handle_);
		if (ptr)
		{
