...
public:
	...
	static inline forward_extractor_data_a ___cast___(any_a<> const& thing)
	{
		...
		return forward_extractor_data_a{ forward_extractor_data_d<_1_>{ thing } };
	}
	...
	static inline forward_extractor_data_a ___cast_ref___(any_a<>& thing)
	{
		...
		return forward_extractor_data_a{ forward_extractor_data_d<_1_>(thing, ___reference_tag___{}) };
	}
...
private:
	...
	friend class ___forward_extractor_data_a_share___;
