...
private:
	...
	struct ___forward_extractor_data_a_handle_final___ final : ___forward_extractor_data_a_handle___<___TTT___>
	{
		...
		{
			return std_make_shared<___forward_extractor_data_a_handle_final___>(___forward_extractor_data_a_handle___<___TTT___>::___value___);
		}
	};
...
public:
	...
	explicit inline forward_extractor_data_a(___TTT___ value) noexcept
		: forward_extractor_a< _element >{ std_make_shared<___forward_extractor_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	explicit inline forward_extractor_data_a(any_a<>::___variadic_tag___, ___TTT___*, Args&&... args)
		: forward_extractor_a< _element >{ std_make_shared<___forward_extractor_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
