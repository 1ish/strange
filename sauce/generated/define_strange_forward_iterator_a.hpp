...
private:
	...
	struct ___forward_iterator_a_handle_final___ final : ___forward_iterator_a_handle___<___TTT___>
	{
		...
		{
			return std::make_shared<___forward_iterator_a_handle_final___>(___forward_iterator_a_handle___<___TTT___>::value_);
		}
	};
...
public:
	...
	{
		auto const ptr = std::dynamic_pointer_cast<___forward_iterator_a_handle_base___>(static_cast<forward_iterator_a const&>(thing).handle_);
		if (ptr)
		{
