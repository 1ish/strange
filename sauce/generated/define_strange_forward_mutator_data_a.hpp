...
template <typename _1_>
inline forward_mutator_data_d<_1_> ___forward_mutator_data_dynamic___(any_a<> const& thing); 

template <typename _1_>
class forward_mutator_data_a : public forward_mutator_a<>
{
public:
	inline bool operator==(forward_mutator_data_a < _1_ > const & it ) const
...
protected:
	struct ___forward_mutator_data_a_handle_base___ : ___forward_mutator_a_handle_base___
	{
		virtual bool operator==(forward_mutator_data_a < _1_ > const & it ) const = 0;
		virtual bool operator!=(forward_mutator_data_a < _1_ > const & it ) const = 0;
	...
	struct ___forward_mutator_data_a_handle___ : ___forward_mutator_a_handle___<___TTT___, ___DHB___>
	{
		...
		inline ___forward_mutator_data_a_handle___(___TTT___ value, typename std::enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: ___forward_mutator_a_handle___<___TTT___, ___DHB___>{ value }
		{}
		...
		inline ___forward_mutator_data_a_handle___(___TTT___ value, typename std::enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
			: ___forward_mutator_a_handle___<___TTT___, ___DHB___>{ std::move(value) }
		{}

		template <typename... Args>
		inline ___forward_mutator_data_a_handle___(___variadic_tag___, Args&&... args)
			: ___forward_mutator_a_handle___<___TTT___, ___DHB___>(___variadic_tag___{}, std::forward<Args>(args)...)
		{}

		virtual inline bool operator==(forward_mutator_data_a < _1_ > const & it ) const final
...
private:
	...
	struct ___forward_mutator_data_a_handle_final___ final : ___forward_mutator_data_a_handle___<___TTT___>
	{
		...
		template <typename... Args>
		inline ___forward_mutator_data_a_handle_final___(___variadic_tag___, Args&&... args)
			: ___forward_mutator_data_a_handle___<___TTT___>(___variadic_tag___{}, std::forward<Args>(args)...)
		{}
...
protected:
	...
	{
		return *std::static_pointer_cast<___forward_mutator_data_a_handle_base___ const>(___handle___);
	}
	...
	inline ___forward_mutator_data_a_handle_base___& ___write___() noexcept
	{
		...
		return *std::static_pointer_cast<___forward_mutator_data_a_handle_base___>(___handle___);
	}
...
public:
	...
	{
		return forward_mutator_data_a(other, ___reference_tag___{});
	}

	static inline forward_mutator_data_a dup(forward_mutator_data_a& other) noexcept
	{
		return forward_mutator_data_a(other, ___duplicate_tag___{});
	}

	inline forward_mutator_data_a() = default;

	inline forward_mutator_data_a(forward_mutator_data_a& other, ___reference_tag___) noexcept
		: forward_mutator_a(other, ___reference_tag___{})
	{}

	inline forward_mutator_data_a(forward_mutator_data_a& other, ___duplicate_tag___) noexcept
		: forward_mutator_a(other, ___duplicate_tag___{})
	{}
	...
	template <typename ___TTT___>
	explicit inline forward_mutator_data_a(std::shared_ptr<___TTT___>& handle, ___reference_tag___) noexcept
		: forward_mutator_a(handle, ___reference_tag___{})
	{
		assert(!handle || std::dynamic_pointer_cast<___forward_mutator_data_a_handle_base___>(handle));
	}
	...
	explicit inline forward_mutator_data_a(___variadic_tag___, ___TTT___*, Args&&... args)
		: forward_mutator_a{ std::make_shared<___forward_mutator_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		___handle___->___weak___(___handle___);
	}
	...
	static inline forward_mutator_data_a ___cast___(any_a<> const& thing)
	{
		...
		return forward_mutator_data_a{ forward_mutator_data_d<_1_>{ thing } };
	}
	...
	static inline forward_mutator_data_a ___cast_ref___(any_a<>& thing)
	{
		...
		if (ptr)
		{
			return forward_mutator_data_a(thing.___handle___, ___reference_tag___{});
		}
		return forward_mutator_data_a{ forward_mutator_data_d<_1_>(thing, ___reference_tag___{}) };
	}
	...
	static inline ___unordered_herd_a___ ___cats___()
	{
		...
		{
			auto cats = forward_mutator_a::___cats___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
	...
	static inline ___unordered_herd_a___ ___kinds___()
	{
		...
		{
			auto kinds = forward_mutator_a::___kinds___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
	...
	static inline ___unordered_shoal_a___ ___operations___()
	{
		...
		{
			___unordered_shoal_a___ operations = forward_mutator_a::___operations___<___unordered_shoal_a___>();
			return operations;
		}();
		return OPERATIONS;
	}
	...
	{
		return forward_mutator_data_a(___variadic_tag___{}, static_cast<___TTT___*>(nullptr), std::forward<Args>(args)...);
	}

private:
	static bool const ___share___;
	friend class ___forward_mutator_data_a_share___;
...
public:
	...
	explicit forward_mutator_data_d(any_a<>& thing, ___reference_tag___)
		: forward_mutator_d<>{ thing, ___reference_tag___{} }
	{}

	explicit forward_mutator_data_d(any_a<>& thing, ___duplicate_tag___)
