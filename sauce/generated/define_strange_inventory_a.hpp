...
public:
	...
	explicit inline inventory_a(std::shared_ptr<___inventory_a_handle_base___> const& handle) noexcept
		: collection_a{ handle }
	{}

	explicit inline inventory_a(std::shared_ptr<___inventory_a_handle_base___>& handle, ___reference_tag___) noexcept
