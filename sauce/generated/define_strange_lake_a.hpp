...
public:
	...
	explicit inline lake_a(std::shared_ptr<___lake_a_handle_base___> const& handle) noexcept
		: inventory_a{ handle }
	{}

	explicit inline lake_a(std::shared_ptr<___lake_a_handle_base___>& handle, ___reference_tag___) noexcept
