...
public:
	...
	explicit inline number_data_a(___variadic_tag___, Args&&... args)
		: number_a{ std::make_shared<___number_data_a_handle_final___<typename std::remove_reference<___TTT___>::type>>(___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		___handle___->___weak___(___handle___);
	}
	...
	{
		static ___cat_a___ CAT = cat_create<___cat_a___>(1, "strange::number_data");
		return CAT;
	}
