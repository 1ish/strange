...
protected:
	...
	struct ___operation_a_handle___ : any_a<>::template ___any_a_handle___<___TTT___, ___DHB___>
	{
		...
		inline ___operation_a_handle___(___TTT___ value, typename std_enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: any_a<>::template ___any_a_handle___<___TTT___, ___DHB___>{ value }
		{}

		template <typename ___UUU___ = ___TTT___>
		inline ___operation_a_handle___(___TTT___ value, typename std_enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
...
private:
	...
	{
		template <typename ___UUU___ = ___TTT___>
		inline ___operation_a_handle_final___(___TTT___ value, typename std_enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: ___operation_a_handle___<___TTT___>{ value }
		{}

		template <typename ___UUU___ = ___TTT___>
		inline ___operation_a_handle_final___(___TTT___ value, typename std_enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
...
public:
	...
	template <typename ___TTT___>
	explicit inline operation_a(std_shared_ptr<___TTT___> const& handle) noexcept
		: any_a<>{ handle }
	{
	...
	template <typename ___TTT___>
	explicit inline operation_a(std_shared_ptr<___TTT___>& handle, any_a<>::___reference_tag___) noexcept
		: any_a<>(handle, any_a<>::___reference_tag___{})
	{
		assert(!handle || std::dynamic_pointer_cast<___operation_a_handle_base___>(handle));
	}

	template <typename ___TTT___, typename = typename std_enable_if_t<!std::is_base_of<operation_a, std::decay_t<___TTT___>>::value>>
	...
	template <typename ___TTT___>
	inline operation_a& operator=(std_shared_ptr<___TTT___> const& handle) noexcept
	{
		assert(!handle || std::dynamic_pointer_cast<___operation_a_handle_base___>(handle));
