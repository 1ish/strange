...
private:
	...
	struct ___parser_a_handle_final___ final : ___parser_a_handle___<___TTT___>
	{
		...
		{
			return std_make_shared<___parser_a_handle_final___>(___parser_a_handle___<___TTT___>::___value___);
		}
	};
...
public:
	...
	template <typename ___TTT___>
	explicit inline parser_a(std_shared_ptr<___TTT___> const& handle) noexcept
		: any_a<>{ handle }
	{
	...
	template <typename ___TTT___>
	explicit inline parser_a(std_shared_ptr<___TTT___>& handle, any_a<>::___reference_tag___) noexcept
	...
	explicit inline parser_a(___TTT___ value) noexcept
		: any_a<>{ std_make_shared<___parser_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	explicit inline parser_a(any_a<>::___variadic_tag___, ___TTT___*, Args&&... args)
		: any_a<>{ std_make_shared<___parser_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}

	template <typename ___TTT___>
	inline parser_a& operator=(std_shared_ptr<___TTT___> const& handle) noexcept
	{
		assert(!handle || std::dynamic_pointer_cast<___parser_a_handle_base___>(handle));
