...
public:
	...
	explicit inline parser_a(std::shared_ptr<___parser_a_handle_base___> const& handle) noexcept
		: any_a{ handle }
	{}

	explicit inline parser_a(std::shared_ptr<___parser_a_handle_base___>& handle, ___reference_tag___) noexcept
