...
public:
	...
	inline random_access_const_iterator_a& operator+=(number_a<> const& number)
	{
		assert(___handle___);
		___write___().self_add_(number);
		return *this;
...
protected:
	...
	struct ___random_access_const_iterator_a_handle___ : ___bidirectional_const_iterator_a_handle___<___TTT___, ___DHB___>
	{
		...
		inline ___random_access_const_iterator_a_handle___(___variadic_tag___, Args&&... args)
...
private:
	...
	struct ___random_access_const_iterator_a_handle_final___ final : ___random_access_const_iterator_a_handle___<___TTT___>
	{
		...
		template <typename... Args>
		inline ___random_access_const_iterator_a_handle_final___(___variadic_tag___, Args&&... args)
			: ___random_access_const_iterator_a_handle___<___TTT___>(___variadic_tag___{}, std::forward<Args>(args)...)
		{}

		virtual inline ___SHARED___ ___clone___() const final
		{
			return std::make_shared<___random_access_const_iterator_a_handle_final___>(___random_access_const_iterator_a_handle___<___TTT___>::___value___);
		}
	};
...
protected:
	inline ___random_access_const_iterator_a_handle_base___ const& ___read___() const noexcept
	{
		return *std::static_pointer_cast<___random_access_const_iterator_a_handle_base___ const>(___handle___);
	}

	inline ___random_access_const_iterator_a_handle_base___& ___write___() noexcept
	{
...
public:
	...
	explicit inline random_access_const_iterator_a(___TTT___ value) noexcept
		: bidirectional_const_iterator_a{ std::make_shared<___random_access_const_iterator_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		___handle___->___weak___(___handle___);
	}

	template <typename ___TTT___, typename... Args>
	explicit inline random_access_const_iterator_a(___variadic_tag___, ___TTT___*, Args&&... args)
		: bidirectional_const_iterator_a{ std::make_shared<___random_access_const_iterator_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		___handle___->___weak___(___handle___);
	}
	...
	static inline random_access_const_iterator_a ___cast___(any_a<> const& thing)
	{
		...
		if (ptr)
		{
			return random_access_const_iterator_a{ thing.___handle___ };
		}
		return random_access_const_iterator_a{ random_access_const_iterator_d<_1_>{ thing } };
	}

	static inline random_access_const_iterator_a ___cast_ref___(any_a<>& thing)
	{
		auto const ptr = std::dynamic_pointer_cast<___random_access_const_iterator_a_handle_base___>(thing.___handle___);
		if (ptr)
		{
			return random_access_const_iterator_a(thing.___handle___, ___reference_tag___{});
		}
	...
	{
		static ___cat_a___ CAT = cat_create<___cat_a___>(1, "strange::random_access_const_iterator");
		return CAT;
	}
	...
	template <typename ___TTT___, typename... Args>
	static inline random_access_const_iterator_a create(Args&&... args)
	{
		return random_access_const_iterator_a(___variadic_tag___{}, static_cast<___TTT___*>(nullptr), std::forward<Args>(args)...);
	}
...
public:
	...
	explicit random_access_const_iterator_d(any_a<>& thing, ___reference_tag___)
		: bidirectional_const_iterator_d<>{ thing, ___reference_tag___{} }
	{}

	explicit random_access_const_iterator_d(any_a<>& thing, ___duplicate_tag___)
