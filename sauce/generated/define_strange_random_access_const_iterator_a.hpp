...
public:
	...
	explicit inline random_access_const_iterator_a(___variadic_tag___, Args&&... args)
		: bidirectional_const_iterator_a{ std::make_shared<___random_access_const_iterator_a_handle_final___<typename std::remove_reference<___TTT___>::type>>(___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		___handle___->___weak___(___handle___);
	}
