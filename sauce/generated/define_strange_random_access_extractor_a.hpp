...
public:
	...
	static inline ___unordered_shoal_a___ ___operations___()
	{
		static ___unordered_shoal_a___ OPERATIONS = []()
		{
			...
			operations.update_string("less_than_", native_extraction_t<random_access_extractor_a>::create(&random_access_extractor_a::less_than__));
			operations.update_string("greater_than_", native_extraction_t<random_access_extractor_a>::create(&random_access_extractor_a::greater_than__));
			operations.update_string("less_or_equal_", native_extraction_t<random_access_extractor_a>::create(&random_access_extractor_a::less_or_equal__));
			operations.update_string("greater_or_equal_", native_extraction_t<random_access_extractor_a>::create(&random_access_extractor_a::greater_or_equal__));
			return operations;
		}();
		return OPERATIONS;
	}
...
private:
	...
	friend class ___random_access_extractor_a_share___;
...
public:
	...
	inline any_a<> less_than__(range_a<> const& arguments) const
	{
		...
		if (!op)
		{
			throw dis("dynamic random_access_extractor_d::less_than_ passed non-existent member");
		}
		return op.operate(*const_cast<random_access_extractor_d*>(this), arguments);
	}
	...
	inline any_a<> greater_than__(range_a<> const& arguments) const
	{
		...
		if (!op)
		{
			throw dis("dynamic random_access_extractor_d::greater_than_ passed non-existent member");
		}
		return op.operate(*const_cast<random_access_extractor_d*>(this), arguments);
	}
	...
	inline any_a<> less_or_equal__(range_a<> const& arguments) const
	{
		...
		if (!op)
		{
			throw dis("dynamic random_access_extractor_d::less_or_equal_ passed non-existent member");
		}
		return op.operate(*const_cast<random_access_extractor_d*>(this), arguments);
	}
	...
	inline any_a<> greater_or_equal__(range_a<> const& arguments) const
	{
		...
		if (!op)
		{
			throw dis("dynamic random_access_extractor_d::greater_or_equal_ passed non-existent member");
		}
		return op.operate(*const_cast<random_access_extractor_d*>(this), arguments);
	}
