...
class random_access_extractor_a : public bidirectional_extractor_a< any_a<> >
{
public:
...
protected:
	struct ___random_access_extractor_a_handle_base___ : bidirectional_extractor_a< any_a<> >::___bidirectional_extractor_a_handle_base___
	{
	...
	struct ___random_access_extractor_a_handle___ : bidirectional_extractor_a< any_a<> >::template ___bidirectional_extractor_a_handle___<___TTT___, ___DHB___>
	{
		...
		inline ___random_access_extractor_a_handle___(___TTT___ value, typename std::enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: bidirectional_extractor_a< any_a<> >::template ___bidirectional_extractor_a_handle___<___TTT___, ___DHB___>{ value }
		{}
		...
		inline ___random_access_extractor_a_handle___(___TTT___ value, typename std::enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
			: bidirectional_extractor_a< any_a<> >::template ___bidirectional_extractor_a_handle___<___TTT___, ___DHB___>{ std::move(value) }
		{}

		template <typename... Args>
		inline ___random_access_extractor_a_handle___(any_a<>::___variadic_tag___, Args&&... args)
			: bidirectional_extractor_a< any_a<> >::template ___bidirectional_extractor_a_handle___<___TTT___, ___DHB___>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...)
		{}
...
public:
	...
	explicit inline random_access_extractor_a(std::shared_ptr<___TTT___>& handle, any_a<>::___reference_tag___) noexcept
		: bidirectional_extractor_a< any_a<> >(handle, any_a<>::___reference_tag___{})
	{
		assert(!handle || std::dynamic_pointer_cast<___random_access_extractor_a_handle_base___>(handle));
	}
	...
	explicit inline random_access_extractor_a(___TTT___ value) noexcept
		: bidirectional_extractor_a< any_a<> >{ std::make_shared<___random_access_extractor_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	explicit inline random_access_extractor_a(any_a<>::___variadic_tag___, ___TTT___*, Args&&... args)
		: bidirectional_extractor_a< any_a<> >{ std::make_shared<___random_access_extractor_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	{
		static ___cat_a___ CAT = cat_create<___cat_a___>(1, "strange::random_access_extractor");
		return CAT;
	}
	...
	static inline ___unordered_herd_a___ ___cats___()
	{
		...
		{
			auto cats = bidirectional_extractor_a< any_a<> >::template ___cats___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
	...
	static inline ___unordered_herd_a___ ___kinds___()
	{
		...
		{
			auto kinds = bidirectional_extractor_a< any_a<> >::template ___kinds___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
	...
	static inline ___unordered_shoal_a___ ___operations___()
	{
		...
		{
			___unordered_shoal_a___ operations = bidirectional_extractor_a< any_a<> >::template ___operations___<___unordered_shoal_a___>();
...
template <typename _1>
class random_access_extractor_d : public bidirectional_extractor_d< any_a<> >
{
public:
	...
	inline random_access_extractor_a<> self_add_(number_a<> const& number)
	{
		...
		return cast<random_access_extractor_a<>>(variadic_operate(op, *this, number));
	}
	...
	explicit random_access_extractor_d(any_a<> const& thing)
		: bidirectional_extractor_d< any_a<> >{ thing }
	{}

	explicit random_access_extractor_d(any_a<>& thing, any_a<>::___reference_tag___)
		: bidirectional_extractor_d< any_a<> >{ thing, any_a<>::___reference_tag___{} }
	{}

	explicit random_access_extractor_d(any_a<>& thing, any_a<>::___duplicate_tag___)
		: bidirectional_extractor_d< any_a<> >{ thing, any_a<>::___duplicate_tag___{} }
	{}
};
