...
protected:
	...
	struct ___random_access_extractor_data_a_handle___ : random_access_extractor_a<>::template ___random_access_extractor_a_handle___<___TTT___, ___DHB___>
	{
		...
		inline ___random_access_extractor_data_a_handle___(___TTT___ value, typename std::enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: random_access_extractor_a<>::template ___random_access_extractor_a_handle___<___TTT___, ___DHB___>{ value }
		{}
		...
		inline ___random_access_extractor_data_a_handle___(___TTT___ value, typename std::enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
			: random_access_extractor_a<>::template ___random_access_extractor_a_handle___<___TTT___, ___DHB___>{ std::move(value) }
		{}

		template <typename... Args>
		inline ___random_access_extractor_data_a_handle___(any_a<>::___variadic_tag___, Args&&... args)
			: random_access_extractor_a<>::template ___random_access_extractor_a_handle___<___TTT___, ___DHB___>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...)
		{}
...
public:
	...
	inline random_access_extractor_data_a(random_access_extractor_data_a& other, any_a<>::___reference_tag___) noexcept
		: random_access_extractor_a<>(other, any_a<>::___reference_tag___{})
	{}

	inline random_access_extractor_data_a(random_access_extractor_data_a& other, any_a<>::___duplicate_tag___) noexcept
		: random_access_extractor_a<>(other, any_a<>::___duplicate_tag___{})
	{}
	...
	template <typename ___TTT___>
	explicit inline random_access_extractor_data_a(std::shared_ptr<___TTT___>& handle, any_a<>::___reference_tag___) noexcept
		: random_access_extractor_a<>(handle, any_a<>::___reference_tag___{})
	{
		assert(!handle || std::dynamic_pointer_cast<___random_access_extractor_data_a_handle_base___>(handle));
	}
	...
	explicit inline random_access_extractor_data_a(any_a<>::___variadic_tag___, ___TTT___*, Args&&... args)
		: random_access_extractor_a<>{ std::make_shared<___random_access_extractor_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	static inline random_access_extractor_data_a ___cast_ref___(any_a<>& thing)
	{
		...
		return random_access_extractor_data_a{ random_access_extractor_data_d<_type>(thing, any_a<>::___reference_tag___{}) };
	}
	...
	static inline ___unordered_herd_a___ ___cats___()
	{
		...
		{
			auto cats = random_access_extractor_a<>::template ___cats___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
	...
	static inline ___unordered_herd_a___ ___kinds___()
	{
		...
		{
			auto kinds = random_access_extractor_a<>::template ___kinds___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
	...
	static inline ___unordered_shoal_a___ ___operations___()
	{
		...
		{
			___unordered_shoal_a___ operations = random_access_extractor_a<>::template ___operations___<___unordered_shoal_a___>();
			return operations;
		}();
		return OPERATIONS;
	}
