...
public:
	...
	explicit inline random_access_iterator_a(std::shared_ptr<___random_access_iterator_a_handle_base___> const& handle) noexcept
		: bidirectional_iterator_a{ handle }
	{}

	explicit inline random_access_iterator_a(std::shared_ptr<___random_access_iterator_a_handle_base___>& handle, ___reference_tag___) noexcept
