...
inline bool check(random_access_iterator_a<_1_> const& value) noexcept;
...
private:
	...
	struct ___random_access_iterator_a_handle_final___ final : ___random_access_iterator_a_handle___<___TTT___>
	{
		...
		{
			return std::make_shared<___random_access_iterator_a_handle_final___>(___random_access_iterator_a_handle___<___TTT___>::value_);
		}
	};
	...
	friend inline bool check(random_access_iterator_a<_1_> const& value) noexcept;
