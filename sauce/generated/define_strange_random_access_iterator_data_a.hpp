...
public:
	...
	explicit inline random_access_iterator_data_a(___variadic_tag___, ___TTT___*, Args&&... args)
	...
	{
		static ___cat_a___ CAT = cat_create<___cat_a___>(1, "strange::random_access_iterator_data", flock_vals(kind_create<___kind_a___>(2, "")));
		return CAT;
	}
	...
	static inline ___unordered_herd_a___ ___cats___()
	{
		...
		{
			auto cats = random_access_iterator_a::___cats___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
	...
	static inline ___unordered_herd_a___ ___kinds___()
	{
		...
		{
			auto kinds = random_access_iterator_a::___kinds___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
	...
	static inline ___unordered_shoal_a___ ___operations___()
	{
		...
		{
			___unordered_shoal_a___ operations = random_access_iterator_a::___operations___<___unordered_shoal_a___>();
			return operations;
		}();
		return OPERATIONS;
	}
	...
	template <typename ___TTT___, typename... Args>
	static inline random_access_iterator_data_a create(Args&&... args)
	{
		return random_access_iterator_data_a(___variadic_tag___{}, static_cast<___TTT___*>(nullptr), std::forward<Args>(args)...);
	}
...
bool const random_access_iterator_data_a<_1_>::___share___ = []()
{
	...
	reflection<random_access_iterator_data_a<_1_>>::share(shared_shoal);
	return shared_shoal;
}();
...
public:
	...
	inline _1_ const & extract_it() const
	{ throw throw_dis("dynamic random_access_iterator_data_d::extract_it() not available"); }

	inline _1_ & mutate_it()
	{ throw throw_dis("dynamic random_access_iterator_data_d::mutate_it() not available"); }
