...
protected:
	struct ___random_access_mutator_a_handle_base___ : bidirectional_mutator_a<>::template ___bidirectional_mutator_a_handle_base___
	{
...
public:
	...
	static inline random_access_mutator_a ___cast___(any_a<> const& thing)
	{
		...
		return random_access_mutator_a{ random_access_mutator_d<_1>{ thing } };
	}
	...
	static inline random_access_mutator_a ___cast_ref___(any_a<>& thing)
	{
		...
		return random_access_mutator_a{ random_access_mutator_d<_1>(thing, any_a<>::___reference_tag___{}) };
	}
