...
protected:
	struct ___random_access_mutator_a_handle_base___ : bidirectional_mutator_a< _element >::___bidirectional_mutator_a_handle_base___
	{
		...
		virtual random_access_mutator_a< _element > add_(number_a<> const& number) const = 0;
		virtual void self_subtract_(number_a<> const& number) = 0;
		virtual random_access_mutator_a< _element > subtract_(number_a<> const& number) const = 0;
	};

	template <typename ___TTT___, typename ___DHB___ = ___random_access_mutator_a_handle_base___>
	struct ___random_access_mutator_a_handle___ : bidirectional_mutator_a< _element >::template ___bidirectional_mutator_a_handle___<___TTT___, ___DHB___>
	{
		template <typename ___UUU___ = ___TTT___>
		inline ___random_access_mutator_a_handle___(___TTT___ value, typename std_enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: bidirectional_mutator_a< _element >::template ___bidirectional_mutator_a_handle___<___TTT___, ___DHB___>{ value }
		{}

		template <typename ___UUU___ = ___TTT___>
		inline ___random_access_mutator_a_handle___(___TTT___ value, typename std_enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
...
private:
	...
	{
		template <typename ___UUU___ = ___TTT___>
		inline ___random_access_mutator_a_handle_final___(___TTT___ value, typename std_enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: ___random_access_mutator_a_handle___<___TTT___>{ value }
		{}

		template <typename ___UUU___ = ___TTT___>
		inline ___random_access_mutator_a_handle_final___(___TTT___ value, typename std_enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
			: ___random_access_mutator_a_handle___<___TTT___>{ std::move(value) }
		{}

		template <typename... Args>
		inline ___random_access_mutator_a_handle_final___(any_a<>::___variadic_tag___, Args&&... args)
...
protected:
	...
	{
		return *std::static_pointer_cast<___random_access_mutator_a_handle_base___ const>(any_a<>::___handle___);
	}
	...
	inline ___random_access_mutator_a_handle_base___& ___write___() noexcept
	{
		...
		return *std::static_pointer_cast<___random_access_mutator_a_handle_base___>(any_a<>::___handle___);
	}
...
public:
	...
	{
		return random_access_mutator_a(other, any_a<>::___reference_tag___{});
	}

	static inline random_access_mutator_a dup(random_access_mutator_a& other) noexcept
	{
		return random_access_mutator_a(other, any_a<>::___duplicate_tag___{});
	}
	...
	template <typename ___TTT___>
	explicit inline random_access_mutator_a(std_shared_ptr<___TTT___> const& handle) noexcept
	...
	template <typename ___TTT___>
	explicit inline random_access_mutator_a(std_shared_ptr<___TTT___>& handle, any_a<>::___reference_tag___) noexcept
		: bidirectional_mutator_a< _element >(handle, any_a<>::___reference_tag___{})
	{
		assert(!handle || std::dynamic_pointer_cast<___random_access_mutator_a_handle_base___>(handle));
	}

	template <typename ___TTT___, typename = typename std_enable_if_t<!std::is_base_of<random_access_mutator_a, std::decay_t<___TTT___>>::value>>
	explicit inline random_access_mutator_a(___TTT___ value) noexcept
		: bidirectional_mutator_a< _element >{ std::make_shared<___random_access_mutator_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	explicit inline random_access_mutator_a(any_a<>::___variadic_tag___, ___TTT___*, Args&&... args)
		: bidirectional_mutator_a< _element >{ std::make_shared<___random_access_mutator_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}

	template <typename ___TTT___>
	inline random_access_mutator_a& operator=(std_shared_ptr<___TTT___> const& handle) noexcept
	{
		assert(!handle || std::dynamic_pointer_cast<___random_access_mutator_a_handle_base___>(handle));
	...
	static inline random_access_mutator_a ___cast___(any_a<> const& thing)
	{
		...
		return random_access_mutator_a{ random_access_mutator_d<_element>{ thing } };
	}
	...
	static inline random_access_mutator_a ___cast_ref___(any_a<>& thing)
	{
		...
		if (ptr)
		{
			return random_access_mutator_a(thing.___handle___, any_a<>::___reference_tag___{});
		}
		return random_access_mutator_a{ random_access_mutator_d<_element>(thing, any_a<>::___reference_tag___{}) };
	}

	template <typename ___cat_a___ = cat_a<>, typename ___kind_a___ = kind_a<>>
	static inline ___cat_a___ ___cat___()
	{
		static ___cat_a___ CAT = cat_create<___cat_a___>(1, "strange::random_access_mutator", flock_vals(kind_create<___kind_a___>(2, "")));
		return CAT;
	}
	...
	{
		return random_access_mutator_a(any_a<>::___variadic_tag___{}, static_cast<___TTT___*>(nullptr), std::forward<Args>(args)...);
	}
...
public:
	...
	inline random_access_mutator_a< _element > self_add_(number_a<> const& number)
	{
		assert(any_a<>::___handle___);
		auto const op = any_a<>::operation("self_add_");
		if (!op)
	...
	inline random_access_mutator_a< _element > self_subtract_(number_a<> const& number)
	{
		assert(any_a<>::___handle___);
		auto const op = any_a<>::operation("self_subtract_");
		if (!op)
