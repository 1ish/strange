...
protected:
	...
	struct ___random_access_mutator_data_a_handle___ : random_access_mutator_a< _element >::template ___random_access_mutator_a_handle___<___TTT___, ___DHB___>
	{
		...
		inline ___random_access_mutator_data_a_handle___(___TTT___ value, typename std_enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: random_access_mutator_a< _element >::template ___random_access_mutator_a_handle___<___TTT___, ___DHB___>{ value }
		{}

		template <typename ___UUU___ = ___TTT___>
		inline ___random_access_mutator_data_a_handle___(___TTT___ value, typename std_enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
...
private:
	...
	{
		template <typename ___UUU___ = ___TTT___>
		inline ___random_access_mutator_data_a_handle_final___(___TTT___ value, typename std_enable_if_t<std::is_reference<___UUU___>::value>* = 0)
			: ___random_access_mutator_data_a_handle___<___TTT___>{ value }
		{}

		template <typename ___UUU___ = ___TTT___>
		inline ___random_access_mutator_data_a_handle_final___(___TTT___ value, typename std_enable_if_t<!std::is_reference<___UUU___>::value, int>* = 0) noexcept
...
public:
	...
	template <typename ___TTT___, typename = typename std_enable_if_t<!std::is_base_of<random_access_mutator_data_a, std::decay_t<___TTT___>>::value>>
	explicit inline random_access_mutator_data_a(___TTT___ value) noexcept
		: random_access_mutator_a< _element >{ std::make_shared<___random_access_mutator_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(std::move(value)) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	explicit inline random_access_mutator_data_a(any_a<>::___variadic_tag___, ___TTT___*, Args&&... args)
		: random_access_mutator_a< _element >{ std::make_shared<___random_access_mutator_data_a_handle_final___<typename std::remove_reference_t<___TTT___>>>(any_a<>::___variadic_tag___{}, std::forward<Args>(args)...) }
	{
		any_a<>::___handle___->___weak___(any_a<>::___handle___);
	}
	...
	{
		static ___cat_a___ CAT = cat_create<___cat_a___>(1, "strange::random_access_mutator_data", flock_vals(kind_create<___kind_a___>(2, ""), kind_create<___kind_a___>(2, "")));
		return CAT;
	}
	...
	static inline ___unordered_herd_a___ ___cats___()
	{
		...
		{
			auto cats = random_access_mutator_a< _element >::template ___cats___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
	...
	static inline ___unordered_herd_a___ ___kinds___()
	{
		...
		{
			auto kinds = random_access_mutator_a< _element >::template ___kinds___<___cat_a___, ___kind_a___, ___unordered_herd_a___>();
