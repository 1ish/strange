...
public:
	...
	explicit inline range_a(std::shared_ptr<___range_a_handle_base___> const& handle) noexcept
		: any_a{ handle }
	{}

	explicit inline range_a(std::shared_ptr<___range_a_handle_base___>& handle, ___reference_tag___) noexcept
