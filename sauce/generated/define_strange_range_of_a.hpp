...
protected:
	struct ___range_of_a_handle_base___ : any_a<>::template ___any_a_handle_base___
	{
	...
	struct ___range_of_a_handle___ : any_a<>::template ___any_a_handle___<___TTT___, ___DHB___>
	{
