...
public:
	...
	explicit inline river_a(std::shared_ptr<___river_a_handle_base___> const& handle) noexcept
		: range_a{ handle }
	{}

	explicit inline river_a(std::shared_ptr<___river_a_handle_base___>& handle, ___reference_tag___) noexcept
