...
public:
	...
	explicit inline symbol_a(std::shared_ptr<___symbol_a_handle_base___> const& handle) noexcept
		: any_a{ handle }
	{}

	explicit inline symbol_a(std::shared_ptr<___symbol_a_handle_base___>& handle, ___reference_tag___) noexcept
