...
protected:
	...
	struct ___token_a_handle___ : ___any_a_handle___<___TTT___, ___DHB___>
	{
		...
		{ return value_.position__(range); }
		...
		{ return value_.precedence__(range); }
