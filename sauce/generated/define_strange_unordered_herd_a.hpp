...
private:
	...
	friend inline bool check(unordered_herd_a<_1__chk> const& value) noexcept;
...
public:
	...
	static inline unordered_herd_a ___cast_ref___(any_a<> const& thing)
	{
		auto const ptr = std::dynamic_pointer_cast<___unordered_herd_a_handle_base___>(thing.___handle___);
		if (ptr)
		{
	...
	static inline unordered_herd_a ___cast_dup___(any_a<> const& thing)
	{
		auto const ptr = std::dynamic_pointer_cast<___unordered_herd_a_handle_base___>(thing.___handle___);
		if (ptr)
		{
			return unordered_herd_a{ ptr, ___duplicate_tag___{} };
		}
		return unordered_herd_a{ unordered_herd_d<_1_>{ thing, ___duplicate_tag___{} } };
	}
