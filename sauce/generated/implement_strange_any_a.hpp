...
template <typename _symbol, typename _cat, typename _kind, typename _number_data_uint64>
inline any_a<> any_a<_symbol, _cat, _kind, _number_data_uint64>::pack__(list_a<> const& ___arguments___) const
{
	auto ___it___ = ___arguments___.begin_();
	auto ___end___ = ___arguments___.end_();
	if (___it___ == ___end___)
...
template <typename _symbol, typename _cat, typename _kind, typename _number_data_uint64>
inline any_a<> any_a<_symbol, _cat, _kind, _number_data_uint64>::pack_(container_a<> & container) const
{
	if (!___handle___)
	{
...
template <typename _symbol, typename _cat, typename _kind, typename _number_data_uint64>
template <typename ___TTT___, typename ___BHB___>
inline any_a<> any_a<_symbol, _cat, _kind, _number_data_uint64>::___any_a_handle___<___TTT___, ___BHB___>::pack_(container_a<> & container) const
{ return ___value___.pack_(container); }

template <typename _symbol, typename _cat, typename _kind, typename _number_data_uint64>
inline any_a<> any_a<_symbol, _cat, _kind, _number_data_uint64>::pack_unique__(list_a<> const& ___arguments___) const
{
	auto ___it___ = ___arguments___.begin_();
	auto ___end___ = ___arguments___.end_();
	if (___it___ == ___end___)
...
template <typename _symbol, typename _cat, typename _kind, typename _number_data_uint64>
inline any_a<> any_a<_symbol, _cat, _kind, _number_data_uint64>::pack_unique_(container_a<> & container, herd_a< _number_data_uint64 > & unique_herd) const
{
	if (!___handle___)
	{
		//TODO container.from_null_();
...
template <typename _symbol, typename _cat, typename _kind, typename _number_data_uint64>
template <typename ___TTT___, typename ___BHB___>
inline any_a<> any_a<_symbol, _cat, _kind, _number_data_uint64>::___any_a_handle___<___TTT___, ___BHB___>::pack_unique_(container_a<> & container, herd_a< _number_data_uint64 > & unique_herd) const
