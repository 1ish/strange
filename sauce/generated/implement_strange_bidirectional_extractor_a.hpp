...
{
	static cat_a<> CAT = cat_create<cat_a<>>(1, "strange::bidirectional_extractor", flock_vals(kind_create<kind_a<>>(2, "")));
	return CAT;
}

template <typename _element>
inline unordered_herd_a<> bidirectional_extractor_a<_element>::___cats___()
{
...
template <typename _element>
inline unordered_herd_a<> bidirectional_extractor_a<_element>::___kinds___()
{
...
template <typename _element>
inline unordered_shoal_a<> bidirectional_extractor_a<_element>::___operations___()
{
