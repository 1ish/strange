...
template <typename _element, typename _type>
inline cat_a<> bidirectional_extractor_data_a<_element, _type>::___cat___()
{
	static cat_a<> CAT = cat_create<cat_a<>>(1, "strange::bidirectional_extractor_data", flock_vals(kind_create<kind_a<>>(2, ""), kind_create<kind_a<>>(2, "")));
	return CAT;
}

template <typename _element, typename _type>
inline unordered_herd_a<> bidirectional_extractor_data_a<_element, _type>::___cats___()
{
...
template <typename _element, typename _type>
inline kind_a<> bidirectional_extractor_data_a<_element, _type>::___kind___()
{
...
template <typename _element, typename _type>
inline unordered_herd_a<> bidirectional_extractor_data_a<_element, _type>::___kinds___()
{
...
template <typename _element, typename _type>
inline unordered_shoal_a<> bidirectional_extractor_data_a<_element, _type>::___operations___()
{
