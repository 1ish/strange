...
inline unordered_shoal_a<> collection_a<_key, _value, _element>::___operations___()
{
	static unordered_shoal_a<> OPERATIONS = []()
	{
		...
		operations.update(sym("has_"), native_extraction::create(&collection_a::has__));
		operations.update(sym("at_"), native_extraction::create(&collection_a::at__));
		operations.update(sym("update_"), native_mutation::create(&collection_a::update__));
		operations.update(sym("insert_"), native_mutation::create(&collection_a::insert__));
		operations.update(sym("erase_"), native_mutation::create(&collection_a::erase__));
		operations.update(sym("clear_"), native_mutation::create(&collection_a::clear__));
		operations.update(sym("size_"), native_extraction::create(&collection_a::size__));
		operations.update(sym("empty_"), native_extraction::create(&collection_a::empty__));
		operations.update(sym("push_front_"), native_mutation::create(&collection_a::push_front__));
		operations.update(sym("pop_front_"), native_mutation::create(&collection_a::pop_front__));
		operations.update(sym("push_back_"), native_mutation::create(&collection_a::push_back__));
		operations.update(sym("pop_back_"), native_mutation::create(&collection_a::pop_back__));
		operations.update(sym("self_assign_"), native_mutation::create(&collection_a::self_assign__));
		operations.update(sym("self_add_"), native_mutation::create(&collection_a::self_add__));
		operations.update(sym("add_"), native_extraction::create(&collection_a::add__));
		operations.update(sym("self_subtract_"), native_mutation::create(&collection_a::self_subtract__));
		operations.update(sym("subtract_"), native_extraction::create(&collection_a::subtract__));
		operations.update(sym("read_lock_"), native_extraction::create(&collection_a::read_lock__));
		operations.update(sym("write_lock_"), native_extraction::create(&collection_a::write_lock__));
		return operations;
	}();
	return OPERATIONS;
}
