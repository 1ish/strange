...
inline bool inventory_a<_1>::has_index(int64_t index ) const
{ assert(any_a<>::___handle___); return ___read___().has_index(index); }

template <typename _1>
template <typename ___TTT___, typename ___DHB___>
inline bool inventory_a<_1>::___inventory_a_handle___<___TTT___, ___DHB___>::has_index(int64_t index ) const
{ return any_a<>::___any_a_handle___<___TTT___, ___DHB___>::___value___.has_index(index); }

template <typename _1>
inline any_a < > inventory_a<_1>::at_index(int64_t index ) const
{ assert(any_a<>::___handle___); return ___read___().at_index(index); }

template <typename _1>
template <typename ___TTT___, typename ___DHB___>
inline any_a < > inventory_a<_1>::___inventory_a_handle___<___TTT___, ___DHB___>::at_index(int64_t index ) const
{ return any_a<>::___any_a_handle___<___TTT___, ___DHB___>::___value___.at_index(index); }

template <typename _1>
inline void inventory_a<_1>::update_index(int64_t index , any_a < > const & value )
{ assert(any_a<>::___handle___); ___write___().update_index(index, value); }

template <typename _1>
template <typename ___TTT___, typename ___DHB___>
inline void inventory_a<_1>::___inventory_a_handle___<___TTT___, ___DHB___>::update_index(int64_t index , any_a < > const & value )
{ any_a<>::___any_a_handle___<___TTT___, ___DHB___>::___value___.update_index(index, value); }

template <typename _1>
inline bool inventory_a<_1>::insert_index(int64_t index , any_a < > const & value )
{ assert(any_a<>::___handle___); return ___write___().insert_index(index, value); }

template <typename _1>
template <typename ___TTT___, typename ___DHB___>
inline bool inventory_a<_1>::___inventory_a_handle___<___TTT___, ___DHB___>::insert_index(int64_t index , any_a < > const & value )
{ return any_a<>::___any_a_handle___<___TTT___, ___DHB___>::___value___.insert_index(index, value); }

template <typename _1>
inline bool inventory_a<_1>::erase_index(int64_t index )
{ assert(any_a<>::___handle___); return ___write___().erase_index(index); }

template <typename _1>
template <typename ___TTT___, typename ___DHB___>
inline bool inventory_a<_1>::___inventory_a_handle___<___TTT___, ___DHB___>::erase_index(int64_t index )
...
template <typename _1>
inline random_access_mutator_a< any_a<> > inventory_a<_1>::mutate_begin_()
{ assert(any_a<>::___handle___); return ___write___().mutate_begin_(); }

template <typename _1>
template <typename ___TTT___, typename ___DHB___>
inline random_access_mutator_a< any_a<> > inventory_a<_1>::___inventory_a_handle___<___TTT___, ___DHB___>::mutate_begin_()
...
template <typename _1>
inline random_access_mutator_a< any_a<> > inventory_a<_1>::mutate_end_()
{ assert(any_a<>::___handle___); return ___write___().mutate_end_(); }

template <typename _1>
template <typename ___TTT___, typename ___DHB___>
inline random_access_mutator_a< any_a<> > inventory_a<_1>::___inventory_a_handle___<___TTT___, ___DHB___>::mutate_end_()
