...
inline any_a<> random_access_extractor_a<_element>::self_add__(list_a<> const& ___arguments___)
{
...
template <typename _element>
inline any_a<> random_access_extractor_a<_element>::add__(list_a<> const& ___arguments___) const
{
	auto ___it___ = ___arguments___.begin_();
	auto ___end___ = ___arguments___.end_();
	if (___it___ == ___end___)
...
template <typename _element>
inline any_a<> random_access_extractor_a<_element>::self_subtract__(list_a<> const& ___arguments___)
{
	auto ___it___ = ___arguments___.begin_();
	auto ___end___ = ___arguments___.end_();
	if (___it___ == ___end___)
...
template <typename _element>
inline any_a<> random_access_extractor_a<_element>::subtract__(list_a<> const& ___arguments___) const
{
	auto ___it___ = ___arguments___.begin_();
	auto ___end___ = ___arguments___.end_();
	if (___it___ == ___end___)
...
{
	static cat_a<> CAT = cat_create(1, "strange::random_access_extractor", flock::create_vals(kind_create(2, "")));
	return CAT;
}

template <typename _element>
inline unordered_herd_a<> random_access_extractor_a<_element>::___cats___()
{
	static unordered_herd_a<> CATS = []()
	{
		auto cats = bidirectional_extractor_a< _element >::___cats___();
...
template <typename _element>
inline kind_a<> random_access_extractor_a<_element>::___kind___()
{
...
template <typename _element>
inline unordered_herd_a<> random_access_extractor_a<_element>::___kinds___()
{
	static unordered_herd_a<> KINDS = []()
	{
		auto kinds = bidirectional_extractor_a< _element >::___kinds___();
...
template <typename _element>
inline unordered_shoal_a<> random_access_extractor_a<_element>::___operations___()
{
	static unordered_shoal_a<> OPERATIONS = []()
	{
		unordered_shoal_a<> operations = bidirectional_extractor_a< _element >::___operations___();
		operations.update(sym("self_add_"), native_mutation::create(&random_access_extractor_a::self_add__));
		operations.update(sym("add_"), native_extraction::create(&random_access_extractor_a::add__));
		operations.update(sym("self_subtract_"), native_mutation::create(&random_access_extractor_a::self_subtract__));
		operations.update(sym("subtract_"), native_extraction::create(&random_access_extractor_a::subtract__));
		return operations;
	}();
	return OPERATIONS;
}
