...
public:
	...
	inline void merge(unordered_shoal_a<> const& parent, symbol_a<>& type, cat_a<>& cat, unordered_herd_a<>& cats, kind_a<>& kind, unordered_herd_a<>& kinds)
	{
		...
		else
		{
			...
			{
				throw dis("strange::abstraction::val merge parent type returned non-symbol");
			}
		...
		else
		{
			...
			{
				throw dis("strange::abstraction::val merge parent cat returned non-cat");
			}
		...
		if (cats_op)
		{
			...
			{
				throw dis("strange::abstraction::val merge parent cats returned non-unordered-herd");
			}
			cats += cats_any;
		}
		...
		else
		{
			...
			{
				throw dis("strange::abstraction::val merge parent kind returned non-kind");
			}
		...
		else
		{
			...
			{
				throw dis("strange::abstraction::val merge parent kinds returned non-unordered-herd");
			}
			kinds += kinds_any;
		}
