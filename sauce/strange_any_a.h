...
namespace strange {
    ...
    protected:
      ...
      virtual inline any_a kind__ ( range_a const & _ ) const = 0;
      virtual inline kind_a kind_ ( ) const = 0;
      virtual inline any_a kinds__ ( range_a const & _ ) const = 0;
      ...
      virtual inline one_t const & extract_thing ( ) const
      { return value_.extract_thing( ); }
      virtual inline one_t & mutate_thing ( )
      ...
      { return value_.cats_( ); }
      virtual inline any_a kind__ ( range_a const & _ ) const
      { return value_.kind__(_ ); }
      virtual inline kind_a kind_ ( ) const
      { return value_.kind_( ); }
      virtual inline any_a kinds__ ( range_a const & _ ) const
      { return value_.kinds__(_ ); }
      virtual inline unordered_herd_a kinds_ ( ) const
      ...
      virtual inline any_a invoke ( any_a & thing , range_a const & range ) const
