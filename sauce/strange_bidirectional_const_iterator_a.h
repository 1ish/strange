...
namespace strange {
    ...
    private:
    	...
    	template <typename ___TTT___>
    	friend inline bool check(bidirectional_const_iterator_a<> const& value) noexcept;
    ...
    public:
    	...
    	inline bidirectional_const_iterator_a(bidirectional_const_iterator_a& other, reference_tag) noexcept
    	...
    	{
    		return bidirectional_const_iterator_a(other, reference_tag{});
    	}
    
    	inline bidirectional_const_iterator_a(bidirectional_const_iterator_a& other, duplicate_tag) noexcept
    	...
    	{
    		return bidirectional_const_iterator_a(other, duplicate_tag{});
    	}
    
    #ifdef STRANGE_CHECK_STATIC_CASTS
    	template <typename ___TTT___>
    	explicit inline bidirectional_const_iterator_a(std::shared_ptr<___TTT___> const& handle)
    ...
    #ifdef STRANGE_CHECK_STATIC_CASTS
    	template <typename ___TTT___>
    	explicit inline bidirectional_const_iterator_a(std::shared_ptr<___TTT___> const& handle, bool reference)
    ...
    #else
    	template <typename ___TTT___>
    	explicit inline bidirectional_const_iterator_a(std::shared_ptr<___TTT___> const& handle, bool reference) noexcept
    		: ___derived___(handle, reference)
    	{
    		assert(!handle || std::dynamic_pointer_cast<___dderived_handle_base___>(handle));
    	}
    ...
    #ifdef STRANGE_CHECK_STATIC_CASTS
    	template <typename ___TTT___>
    	explicit inline bidirectional_const_iterator_a(std::shared_ptr<___TTT___>& handle, reference_tag)
    ...
    #else
    	template <typename ___TTT___>
    	explicit inline bidirectional_const_iterator_a(std::shared_ptr<___TTT___>& handle, reference_tag) noexcept
    		: ___derived___(handle, reference_tag{})
    	{
    		assert(!handle || std::dynamic_pointer_cast<___dderived_handle_base___>(handle));
    	}
    ...
    template <typename ___TTT___>
    inline bool check(bidirectional_const_iterator_a<> const& value) noexcept
    {
    	return ___TTT___::___check___(value.handle_);
    }
    
    template <typename ___1___>
    bool const bidirectional_const_iterator_a<___1___>::___share___ = []()
    {
    	auto& shoal = shared();
