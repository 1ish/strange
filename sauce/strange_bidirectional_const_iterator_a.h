...
namespace strange {
    ...
    public:
    	...
    	explicit inline bidirectional_const_iterator_a(std::shared_ptr<___TTT___> const& handle, bool reference = false) noexcept
    	...
    	explicit inline bidirectional_const_iterator_a(___TTT___ value, bool reference = false) noexcept
