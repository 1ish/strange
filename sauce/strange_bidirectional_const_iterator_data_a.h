...
namespace strange {
    ...
    private:
      ...
      { return value_.reference__( ); }
    	...
    	friend inline bool check_(bidirectional_const_iterator_data_a<___1___> const& value) noexcept;
    
    public:
    	static inline char const* ___abstraction_name___() noexcept
    	{
    		return "bidirectional_const_iterator_data_a";
    	}
    		...
    		: ___derived___(handle, reference)
    	{
    		...
    		{
    			throw dis__("bidirectional_const_iterator_data_a constructor failed to cast from base to final");
    		}
    	}
    #else
    	template <typename ___TTT___>
    	...
    	inline bidirectional_const_iterator_data_a& operator=(std::shared_ptr<___TTT___> const& handle)
    	{
    		if (!std::dynamic_pointer_cast<___finale_handle_base___>(handle))
    		{
    			throw dis__("bidirectional_const_iterator_data_a assignment failed to cast from base to final");
    		}
    		handle_ = handle;
    		handle_->___weak___(handle_);
    		return *this;
    ...
    template <typename ___TTT___, typename ___1___>
    inline bool check_(bidirectional_const_iterator_data_a<___1___> const& value) noexcept
    {
