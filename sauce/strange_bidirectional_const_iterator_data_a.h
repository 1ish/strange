...
namespace strange {
    ...
    class bidirectional_const_iterator_data_a final : public ___derived___
    ...
    public:
    	...
    	inline bidirectional_const_iterator_data_a& operator+=(___root___ const& other)
    ...
    private:
      ...
      { return value_.mutate_it( ); }
    	...
    	friend inline bool check(bidirectional_const_iterator_data_a<___1___> const& value) noexcept;
    ...
    public:
    	...
    	inline bidirectional_const_iterator_data_a(bidirectional_const_iterator_data_a const& other, bool reference) noexcept
    	...
    	inline bidirectional_const_iterator_data_a(bidirectional_const_iterator_data_a& other, reference_tag) noexcept
...

    	{
    		...
    		return bidirectional_const_iterator_data_a(other, reference_tag{});

    	}

    

    	inline bidirectional_const_iterator_data_a(bidirectional_const_iterator_data_a& other, duplicate_tag) noexcept
...

    	{
    		...
    		return bidirectional_const_iterator_data_a(other, duplicate_tag{});
...

    	{
...

    		{
    			...
    			throw dis("bidirectional_const_iterator_data_a constructor failed to cast from base to final");
    	...
    	explicit inline bidirectional_const_iterator_data_a(std::shared_ptr<___TTT___> const& handle, bool reference)
    	...
    	explicit inline bidirectional_const_iterator_data_a(std::shared_ptr<___TTT___> const& handle, bool reference) noexcept
    	...
    	explicit inline bidirectional_const_iterator_data_a(std::shared_ptr<___TTT___>& handle, reference_tag)
    	...
    	explicit inline bidirectional_const_iterator_data_a(std::shared_ptr<___TTT___>& handle, reference_tag) noexcept
...

    	{
...

    		{
    			...
    			throw dis("bidirectional_const_iterator_data_a assignment failed to cast from base to final");
    ...
    inline bool check(bidirectional_const_iterator_data_a<___1___> const& value) noexcept
    ...
    bool const bidirectional_const_iterator_data_a<___1___>::___share___ = []()

    {

    	auto& shoal = shared();

    	reflection<bidirectional_const_iterator_data_a<___1___>>::share(shoal);
