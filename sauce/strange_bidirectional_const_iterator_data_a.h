...
namespace strange {
    ...
    public:
    	...
    	explicit inline bidirectional_const_iterator_data_a(bool reference) noexcept
    	...
    	inline bidirectional_const_iterator_data_a(bidirectional_const_iterator_data_a&& other, bool reference) noexcept
    	...
    	explicit inline bidirectional_const_iterator_data_a(std::shared_ptr<___TTT___> const& handle, bool reference = false)
    	...
    	explicit inline bidirectional_const_iterator_data_a(std::shared_ptr<___TTT___> const& handle, bool reference = false) noexcept
    	...
    	explicit inline bidirectional_const_iterator_data_a(___TTT___ value, bool reference = false) noexcept
