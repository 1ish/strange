...
public:
	...
	{
		static cat_a<> CAT = cat_t<>::create(1, "strange::bidirectional_const_iterator_data_herd");
		return CAT;
	}
...
public:
	static inline cat_a<> cat()
	{
		static cat_a<> CAT = cat_t<>::create(1, "strange::bidirectional_const_iterator_data_shoal");
		return CAT;
	}
