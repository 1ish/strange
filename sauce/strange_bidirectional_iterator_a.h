...
namespace strange {
    ...
    public:
    	...
    	{
    		return "bidirectional_iterator_a";
    	}
    		...
    		: ___derived___(handle, reference)
    	{
    		...
    		{
    			throw dis__("bidirectional_iterator_a constructor failed to cast from base to dderived");
    		}
    	}
    #else
    	template <typename ___TTT___>
    	...
    	inline bidirectional_iterator_a& operator=(std::shared_ptr<___TTT___> const& handle)
    	{
    		if (!std::dynamic_pointer_cast<___dderived_handle_base___>(handle))
    		{
    			throw dis__("bidirectional_iterator_a assignment failed to cast from base to dderived");
    		}
    		handle_ = handle;
    		handle_->___weak___(handle_);
    		return *this;
