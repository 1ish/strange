...
namespace strange {
    ...
    public:
    	...
    	explicit inline bidirectional_iterator_data_a(std::shared_ptr<___TTT___> const& handle, bool reference)
    	...
    	explicit inline bidirectional_iterator_data_a(std::shared_ptr<___TTT___> const& handle, bool reference) noexcept
    	...
    	explicit inline bidirectional_iterator_data_a(std::shared_ptr<___TTT___>& handle, reference_tag)
    	...
    	explicit inline bidirectional_iterator_data_a(std::shared_ptr<___TTT___>& handle, reference_tag) noexcept
