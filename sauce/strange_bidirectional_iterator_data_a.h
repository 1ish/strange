...
namespace strange {
    ...
    private:
      ...
      { return value_.reference__( ); }
    	...
    	friend inline bool check_(bidirectional_iterator_data_a<___1___> const& value);
    ...
    public:
    	...
    	explicit inline bidirectional_iterator_data_a(bool reference)
    	...
    	inline bidirectional_iterator_data_a(bidirectional_iterator_data_a const& other, bool reference)
    	...
    	inline bidirectional_iterator_data_a(bidirectional_iterator_data_a&& other, bool reference)
    	...
    	explicit inline bidirectional_iterator_data_a(___TTT___ value, bool reference = false)
    	...
    	inline bidirectional_iterator_data_a& operator=(___TTT___ value)
    ...
    inline bool check_(bidirectional_iterator_data_a<___1___> const& value)
