...
public:
	...
	{
		typename concurrent_u<_concurrent_>::read_lock lock(_mutex);
		return const_iterator_t<typename std_deque_number::const_iterator>::create(thing_t<___ego___>::me_(), *this, _deque.cbegin());
	}
	...
	{
		typename concurrent_u<_concurrent_>::read_lock lock(_mutex);
		return iterator_t<typename std_deque_number::iterator>::create(*this, _deque.end());
	}
