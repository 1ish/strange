...
namespace strange {
    ...
    public:
     ...
     { assert(handle_); return read().kind( ); }
    ...
    private:
      ...
      virtual inline any_a < > kind_ ( ) const = 0;
      virtual inline bool kind ( ) const = 0;
      ...
      virtual inline any_a < > kind_ ( ) const
      { return value_.kind_( ); }
      virtual inline bool kind ( ) const
      { return value_.kind( ); }
