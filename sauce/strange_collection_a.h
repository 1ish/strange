...
namespace strange {
    ...
    protected:
      ...
      virtual inline any_a < > update_ ( any_a < > const & key , any_a < > const & value = no ( ) ) = 0;
      virtual inline void update ( any_a < > const & key , any_a < > const & value ) = 0;
      virtual inline any_a < > insert__ ( range_a < > const & range ) = 0;
      virtual inline any_a < > insert_ ( any_a < > const & key , any_a < > const & value = no ( ) ) = 0;
      ...
      virtual inline any_a < > update_ ( any_a < > const & key , any_a < > const & value = no ( ) )
      ...
      virtual inline any_a < > insert_ ( any_a < > const & key , any_a < > const & value = no ( ) )
      ...
      virtual inline collection_a self_assign_ ( range_a < > const & range )
    ...
    private:
    	...
    	template <typename ___TTT___>
    	friend inline bool check(collection_a<> const& value) noexcept;
    ...
    #ifdef STRANGE_CHECK_STATIC_CASTS
    	template <typename ___TTT___>
    	explicit inline collection_a(std::shared_ptr<___TTT___> const& handle, bool reference)
    ...
    #else
    	template <typename ___TTT___>
    	explicit inline collection_a(std::shared_ptr<___TTT___> const& handle, bool reference) noexcept
    		: ___derived___(handle, reference)
    	{
    		assert(!handle || std::dynamic_pointer_cast<___dderived_handle_base___>(handle));
    	}
    ...
    template <typename ___TTT___>
    inline bool check(collection_a<> const& value) noexcept
    {
    	return ___TTT___::___check___(value.handle_);
    }
    
    template <typename ___1___>
    bool const collection_a<___1___>::___share___ = []()
    {
    	auto& shoal = shared();
    	reflection<collection_a<___1___>>::share(shoal);
