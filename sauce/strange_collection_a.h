...
namespace strange {
    ...
    public:
    	...
    	inline collection_a(collection_a const& other, bool reference)
...

    	{
...

    		{
    			...
    			throw dis__("collection constructor failed to cast from base to derived");
...

    	{
...

    		{
    			...
    			throw dis__("collection assignment failed to cast from base to derived");
