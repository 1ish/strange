...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_and_t<___ego___>>(range);
	}
	...
	{
		shoal.update_string("strange::expression_and::create", native_function_create(&expression_and_t<>::create__));
	}
