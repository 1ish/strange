...
public:
	...
	{
		shoal.update_string("strange::expression_break::create", native_function_t<>::create(&expression_break_t<>::over::create__));
		shoal.update_string("break!", native_function_t<>::create(&expression_break_t<>::over::create__));
	}
};
