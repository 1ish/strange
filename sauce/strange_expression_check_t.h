...
public:
	...
	{
		shoal.update(sym("strange::expression_check::create"), native_function::create(&expression_check_t<>::create__));
		shoal.update(sym("check!"), native_function::create(&expression_check_t<>::create__));
	}
