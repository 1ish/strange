...
public:
	...
	{
		shoal.update_string("strange::expression_continue::val", native_function_t<>::val(&expression_continue_t<>::over::val__));
		shoal.update_string("strange::continue_", native_function_t<>::val(&expression_continue_t<>::over::val__));
	}
};
