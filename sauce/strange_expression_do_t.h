...
public:
	...
	{
		shoal.update(sym("strange::expression_do::create"), native_function::create(&expression_do_t<>::create__));
		shoal.update(sym("do!"), native_function::create(&expression_do_t<>::create__));
	}
