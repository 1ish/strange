...
public:
	...
	{
		shoal.update(sym("strange::expression_for::create"), native_function::create(&expression_for_t<>::create__));
		shoal.update(sym("for!"), native_function::create(&expression_for_t<>::create__));
	}
