...
class expression_herd_t : public expression_t<_ABSTRACTION_>
{
public:
	// override
...
bool const expression_herd_t<_ABSTRACTION_>::___share___ = []()
{
	auto shoal = shoal_a<>(shared(), true);
	expression_herd_t<_ABSTRACTION_>::share(shoal);
	return shoal;
}();
