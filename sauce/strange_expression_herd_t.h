...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_herd_t<___ego___>>(list);
	}
	...
	{
		shoal.update(sym("strange::expression_herd::create"), native_function::create(&expression_herd_t<>::create__));
	}
