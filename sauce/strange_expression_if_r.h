...
public:
	...
	{
		shoal.update_string("strange::expression_if::val", native_function_t<>::val(&expression_if_t<>::over::val__));
		shoal.update_string("strange::if_", native_function_t<>::val(&expression_if_t<>::over::val__));
	}
};
