...
public:
	...
	{
		shoal.update(sym("strange::expression_if::create"), native_function::create(&expression_if_t<>::create__));
		shoal.update(sym("if!"), native_function::create(&expression_if_t<>::create__));
	}
