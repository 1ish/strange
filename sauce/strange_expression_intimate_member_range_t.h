...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_intimate_member_range_t<___ego___>>(list);
	}
	...
	{
		// nope: shoal.update(sym("strange::expression_intimate_member_range::create"), native_function::create(&expression_intimate_member_range_t<>::create__));
	}
...
protected:
	...
	static inline std_pair<bool, bool> is_pure_literal(token_a<> const& token, symbol_a<> const& member, expression_a<> const& range_expression)
	{
