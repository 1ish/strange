...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_intimate_member_t<___ego___>>(list);
	}
	...
	{
		// nope: shoal.update(sym("strange::expression_intimate_member::create"), native_function::create(&expression_intimate_member_t<>::create__));
	}
	...
	{
		return expression_t<___ego___>::template recreate_expression<expression_intimate_member_t<___ego___>>(expression_t<___ego___>::me_());
	}
...
protected:
	...
	static inline std_pair<bool, bool> is_pure_literal(token_a<> const& token, symbol_a<> const& member)
	{
