...
class expression_intimate_range_t : public expression_t<___ego___>
{
public:
	// override
...
bool const expression_intimate_range_t<___ego___>::___share___ = []()
{
	auto shoal = shoal_a<>(shared(), true);
	expression_intimate_range_t<___ego___>::share(shoal);
	return shoal;
}();
