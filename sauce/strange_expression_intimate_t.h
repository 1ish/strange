...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_intimate_t<___ego___>>(range);
	}
	...
	{
		// nope: shoal.update_string("strange::expression_intimate::create", native_function_create(&expression_intimate_t<>::create__));
	}
