...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_local_at_t<___ego___>>(range);
	}
	...
	{
		shoal.update_string("strange::expression_local_at::create", native_function_create(&expression_local_at_t<>::create__));
	}
