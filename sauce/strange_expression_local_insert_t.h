...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_local_insert_t<___ego___>>(list);
	}
	...
	{
		shoal.update(sym("strange::expression_local_insert::create"), native_function::create(&expression_local_insert_t<>::create__));
	}
