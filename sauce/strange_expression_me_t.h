...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_me_t<___ego___>>(list);
	}
	...
	{
		shoal.update(sym("strange::expression_me::create"), native_function::create(&expression_me_t<>::create__));
	}
