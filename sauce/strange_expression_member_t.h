...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_member_t<___ego___>>(list);
	}
	...
	{
		shoal.update(sym("strange::expression_member::create"), native_function::create(&expression_member_t<>::create__));
	}
