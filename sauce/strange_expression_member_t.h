...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_member_t<___ego___>>(range);
	}
	...
	{
		shoal.update(sym("strange::expression_member::create"), native_function_create(&expression_member_t<>::create__));
	}
...
protected:
	...
	static inline std_pair<bool, bool> is_pure_literal(token_a<> const& token, expression_a<> const& thing_expression, symbol_a<> const& member)
	{
