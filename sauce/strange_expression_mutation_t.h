...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_mutation_t<___ego___>>(range);
	}
	...
	static inline expression_a<> create_(token_a<> const& token, flock_a<> const& terms)
	{
		...
		return expression_substitute_t<expression_mutation_t<>>::create(expression_mutation_t<>(token, terms, fast<symbol_a<>>(scope), names, kinds, expressions, defaults, fast<expression_a<>>(expression)),
	...
	{
		shoal.update_string("strange::expression_mutation::create", native_function_create(&expression_mutation_t<>::create__));
	}
