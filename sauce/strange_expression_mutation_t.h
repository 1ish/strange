	...
	static inline expression_a<> create_(token_a<> const& token, flock_a<> const& terms)
	{
		...
		while (!end)
		{
				...
				term.type_().is("strange::expression_local_update"))
			{
				...
				{
					throw dis(token.report() + "strange::expression_mutation::create passed non-kind");
				}
...
protected:
	...
	inline expression_mutation_t(token_a<> const& token, flock_a<> const& terms, flock_a<> const& names, flock_a<> const& params, flock_a<> const& values, flock_a<> const& defaults, symbol_a<> const& name, kind_a<> const& result, expression_a<> const& expression)
