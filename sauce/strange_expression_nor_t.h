...
public:
	...
	static inline expression_a<> create_(token_a<> const& token, flock_a<> const& terms)
	{
		...
		return expression_a<>::create<over>(expression_nor_t<>(token, terms, fast<expression_a<>>(left), fast<expression_a<>>(right)));
	}
	...
	{
		shoal.update_string("strange::expression_nor::create", native_function_create(&expression_nor_t<>::over::create__));
	}
