...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_nor_t<___ego___>>(range);
	}
	...
	{
		shoal.update_string("strange::expression_nor::create", native_function_create(&expression_nor_t<>::create__));
	}
