...
public:
	...
	{
		shoal.update_string("strange::expression_operate_range::create", native_function_create(&expression_operate_range_t<>::create__));
	}
	...
	{
		return expression_t<___ego___>::template recreate_expression<expression_operate_range_t<___ego___>>(expression_t<___ego___>::me_());
	}
