...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_operate_t<___ego___>>(range);
	}
	...
	{
		shoal.update_string("strange::expression_operate::create", native_function_create(&expression_operate_t<>::create__));
	}
