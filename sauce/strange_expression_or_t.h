...
public:
	...
	static inline expression_a<> create_(token_a<> const& token, flock_a<> const& terms)
	{
		...
		return expression_a<>::create<over>(expression_or_t<>(token, terms, cast<expression_a<>>(left), cast<expression_a<>>(right)));
	}
	...
	{
		shoal.update_string("strange::expression_or::create", native_function_create(&expression_or_t<>::over::create__));
	}
