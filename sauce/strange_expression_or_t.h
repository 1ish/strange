...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_or_t<___ego___>>(range);
	}
	...
	{
		shoal.update_string("strange::expression_or::create", native_function_create(&expression_or_t<>::create__));
	}
