...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_pipe_t<___ego___>>(range);
	}
	...
	{
		shoal.update_string("strange::expression_pipe::create", native_function_create(&expression_pipe_t<>::create__));
	}
