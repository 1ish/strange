...
public:
	...
	{
		shoal.update_string("strange::expression_return::create", native_function_t<>::create(&expression_return_t<>::over::create__));
		shoal.update_string("return!", native_function_t<>::create(&expression_return_t<>::over::create__));
	}
};
