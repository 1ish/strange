...
public:
	...
	{
		shoal.update(sym("strange::expression_return::create"), native_function::create(&expression_return_t<>::create__));
		shoal.update(sym("return!"), native_function::create(&expression_return_t<>::create__));
	}
