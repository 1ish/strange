...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_shared_insert_t<___ego___>>(range);
	}
	...
	{
		shoal.update_string("strange::expression_shared_insert::create", native_function_create(&expression_shared_insert_t<>::create__));
	}
