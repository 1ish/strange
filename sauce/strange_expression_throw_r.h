...
public:
	...
	{
		shoal.update_string("strange::expression_throw::create", native_function_t<>::create(&expression_throw_t<>::over::create__));
		shoal.update_string("throw!", native_function_t<>::create(&expression_throw_t<>::over::create__));
	}
};
