...
public:
	...
	{
		shoal.update_string("strange::expression_while::create", native_function_t<>::create(&expression_while_t<>::over::create__));
		shoal.update_string("while!", native_function_t<>::create(&expression_while_t<>::over::create__));
	}
};
