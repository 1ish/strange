...
public:
	...
	{
		shoal.update(sym("strange::expression_while::create"), native_function::create(&expression_while_t<>::create__));
		shoal.update(sym("while!"), native_function::create(&expression_while_t<>::create__));
	}
