...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_xnor_t<___ego___>>(range);
	}
	...
	{
		shoal.update_string("strange::expression_xnor::create", native_function_create(&expression_xnor_t<>::create__));
	}
