...
public:
	...
	static inline expression_a<> create_(token_a<> const& token, flock_a<> const& terms)
	{
		...
		return expression_a<>::create<over>(expression_xor_t<>( token, terms, cast<expression_a<>>(left), cast<expression_a<>>(right)));
	}
	...
	{
		shoal.update_string("strange::expression_xor::create", native_function_create(&expression_xor_t<>::over::create__));
	}
