...
namespace strange {
    ...
    private:
    	...
    	friend inline bool check_(forward_const_iterator_a<> const& value);
    ...
    public:
    	...
    	explicit inline forward_const_iterator_a(bool reference)
    	...
    	inline forward_const_iterator_a(forward_const_iterator_a const& other, bool reference)
    	...
    	inline forward_const_iterator_a(forward_const_iterator_a&& other, bool reference)
    	...
    	explicit inline forward_const_iterator_a(___TTT___ value, bool reference = false)
    	...
    	inline forward_const_iterator_a& operator=(___TTT___ value)
    ...
    inline bool check_(forward_const_iterator_a<> const& value)
