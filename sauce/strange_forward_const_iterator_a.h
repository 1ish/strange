...
namespace strange {
    ...
    protected:
      ...
      virtual inline any_a < > get ( any_a < > const & _ ) const = 0;
      ...
      virtual inline any_a < > get ( any_a < > const & _ ) const
      { return value_.get(_ ); }
    ...
    private:
    	...
    	friend inline bool check_(forward_const_iterator_a<> const& value) noexcept;
    ...
    public:
...

    	{
    		...
    		return "forward_const_iterator_a";
    	...
    	explicit inline forward_const_iterator_a(bool reference) noexcept
    	...
    	inline forward_const_iterator_a(forward_const_iterator_a&& other, bool reference) noexcept
    	...
    	explicit inline forward_const_iterator_a(std::shared_ptr<___TTT___> const& handle, bool reference = false)
...

    	{
...

    		{
    			...
    			throw dis__("forward_const_iterator_a constructor failed to cast from base to derived");
    	...
    	explicit inline forward_const_iterator_a(std::shared_ptr<___TTT___> const& handle, bool reference = false) noexcept
    	...
    	explicit inline forward_const_iterator_a(___TTT___ value, bool reference = false) noexcept
...

    	{
...

    		{
    			...
    			throw dis__("forward_const_iterator_a assignment failed to cast from base to derived");
    ...
    inline bool check_(forward_const_iterator_a<> const& value) noexcept
