...
namespace strange {
    ...
    private:
      ...
      { return value_.reference__( ); }
    	...
    	friend inline bool check_(forward_const_iterator_data_a<___1___> const& value) noexcept;
    ...
    public:
...

    	{
    		...
    		return "forward_const_iterator_data_a";
    	...
    	explicit inline forward_const_iterator_data_a(bool reference) noexcept
...

    	{
...

    		{
    			...
    			throw dis__("forward_const_iterator_data_a constructor failed to cast from base to final");
    	...
    	explicit inline forward_const_iterator_data_a(std::shared_ptr<___TTT___> const& handle, bool reference = false) noexcept
    	...
    	explicit inline forward_const_iterator_data_a(___TTT___ value, bool reference = false) noexcept
...

    	{
...

    		{
    			...
    			throw dis__("forward_const_iterator_data_a assignment failed to cast from base to final");
    ...
    inline bool check_(forward_const_iterator_data_a<___1___> const& value) noexcept
