...
namespace strange {
    ...
    private:
      ...
      { return value_.reference__( ); }
    	...
    	friend inline bool check_(forward_const_iterator_data_a<___1___> const& value);
    ...
    public:
    	...
    	explicit inline forward_const_iterator_data_a(bool reference)
    	...
    	inline forward_const_iterator_data_a(forward_const_iterator_data_a const& other, bool reference)
    	...
    	inline forward_const_iterator_data_a(forward_const_iterator_data_a&& other, bool reference)
    	...
    	explicit inline forward_const_iterator_data_a(___TTT___ value, bool reference = false)
    	...
    	inline forward_const_iterator_data_a& operator=(___TTT___ value)
    ...
    inline bool check_(forward_const_iterator_data_a<___1___> const& value)
