...
namespace strange {
    ...
    protected:
      ...
      virtual inline any_a < > set ( any_a < > const & range ) const = 0;
      virtual inline any_a < > set_ ( any_a < > const & thing ) const = 0;
      virtual inline any_a < > & operator * ( ) const = 0;
      virtual inline any_a < > * operator -> ( ) const = 0;
      virtual inline forward_iterator_a increment ( any_a < > const & _ ) = 0;
      ...
      { return value_.get_( ); }
      virtual inline any_a < > set ( any_a < > const & range ) const
      ...
      virtual inline any_a < > * operator -> ( ) const
      { return value_.operator->( ); }
      virtual inline forward_iterator_a increment ( any_a < > const & _ )
    ...
    public:
...

    	{
...

    		{
    			...
    			throw dis__("forward_iterator_a constructor failed to cast from base to derived");
...

    	{
...

    		{
    			...
    			throw dis__("forward_iterator_a assignment failed to cast from base to derived");
