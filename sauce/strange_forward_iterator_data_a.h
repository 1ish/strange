...
namespace strange {
    ...
    public:
    	...
    	inline forward_iterator_data_a(forward_iterator_data_a& other, reference_tag) noexcept
...

    	{
    		...
    		return forward_iterator_data_a(other, reference_tag{});

    	}

    

    	inline forward_iterator_data_a(forward_iterator_data_a& other, duplicate_tag) noexcept
...

    	{
    		...
    		return forward_iterator_data_a(other, duplicate_tag{});
    	...
    	explicit inline forward_iterator_data_a(std::shared_ptr<___TTT___>& handle, reference_tag)
    	...
    	explicit inline forward_iterator_data_a(std::shared_ptr<___TTT___>& handle, reference_tag) noexcept
