...
namespace strange {
    ...
    private:
      ...
      { return value_.reference__( ); }
    	...
    	friend inline bool check_(forward_iterator_data_a<___1___> const& value);
    ...
    public:
...

    	{
    		...
    		return "forward_iterator_data_a";
    	...
    	explicit inline forward_iterator_data_a(bool reference)
    	...
    	inline forward_iterator_data_a(forward_iterator_data_a const& other, bool reference)
    	...
    	inline forward_iterator_data_a(forward_iterator_data_a&& other, bool reference)
...

    	{
...

    		{
    			...
    			throw dis__("forward_iterator_data_a constructor failed to cast from base to final");
    	...
    	explicit inline forward_iterator_data_a(___TTT___ value, bool reference = false)
...

    	{
...

    		{
    			...
    			throw dis__("forward_iterator_data_a assignment failed to cast from base to final");
    	...
    	inline forward_iterator_data_a& operator=(___TTT___ value)
    ...
    inline bool check_(forward_iterator_data_a<___1___> const& value)
