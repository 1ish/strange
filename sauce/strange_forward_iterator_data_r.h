...
template<>
class reflection<forward_iterator_data_a<std::unordered_map<any_a<>, any_a<>>::iterator>>
{
public:
...
class ___forward_iterator_data_a_share___
{
	...
	{
		return forward_iterator_data_a<std::unordered_map<any_a<>, any_a<>>::iterator>::___share___;
	}
};
