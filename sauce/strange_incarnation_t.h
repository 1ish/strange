...
class incarnation_t : public unordered_shoal_t<false, _ABSTRACTION_>
{
public:
	// override
...
bool const incarnation_t<_ABSTRACTION_>::___share___ = []()
{
	auto shoal = shoal_a<>(shared(), true);
	incarnation_t<_ABSTRACTION_>::share(shoal);
	return shoal;
}();
