...
namespace strange {
    ...
    public:
    	...
    	explicit inline lake_a(std::shared_ptr<___TTT___> const& handle, bool reference)
    	...
    	explicit inline lake_a(std::shared_ptr<___TTT___> const& handle, bool reference) noexcept
