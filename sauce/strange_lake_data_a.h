...
namespace strange {
    ...
    private:
      ...
      virtual inline std :: vector < _1_ > & reference__ ( ) = 0;
    	};
      ...
      virtual inline void mutate__ ( std :: vector < _1_ > const & data )
      { value_.mutate__(data ); }
      virtual inline std :: vector < _1_ > & reference__ ( )
      { return value_.reference__( ); }
    	...
    	friend inline bool check_(lake_data_a<___1___> const& value);
    ...
    public:
    	...
    	explicit inline lake_data_a(bool reference)
    	...
    	inline lake_data_a(lake_data_a const& other, bool reference)
    	...
    	inline lake_data_a(lake_data_a&& other, bool reference)
...

    	{
...

    		{
    			...
    			throw dis__("lake_data_a constructor failed to cast from base to final");
    	...
    	explicit inline lake_data_a(___TTT___ value, bool reference = false)
...

    	{
...

    		{
    			...
    			throw dis__("lake_data_a assignment failed to cast from base to final");
    	...
    	inline lake_data_a& operator=(___TTT___ value)
    ...
    inline bool check_(lake_data_a<___1___> const& value)
