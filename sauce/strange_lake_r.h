...
public:
	...
	{
		shoal.update("strange::lake_int_8::val", native_function_t<>::val(&lake_int_8_t<>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_uint_8::val", native_function_t<>::val(&lake_uint_8_t<>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_int_16::val", native_function_t<>::val(&lake_int_16_t<>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_uint_16::val", native_function_t<>::val(&lake_uint_16_t<>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_int_32::val", native_function_t<>::val(&lake_int_32_t<>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_uint_32::val", native_function_t<>::val(&lake_uint_32_t<>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_int_64::val", native_function_t<>::val(&lake_int_64_t<>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_uint_64::val", native_function_t<>::val(&lake_uint_64_t<>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_float_32::val", native_function_t<>::val(&lake_float_32_t<>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_float_64::val", native_function_t<>::val(&lake_float_64_t<>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_int_8_concurrent::val", native_function_t<>::val(&lake_int_8_t<true>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_uint_8_concurrent::val", native_function_t<>::val(&lake_uint_8_t<true>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_int_16_concurrent::val", native_function_t<>::val(&lake_int_16_t<true>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_uint_16_concurrent::val", native_function_t<>::val(&lake_uint_16_t<true>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_int_32_concurrent::val", native_function_t<>::val(&lake_int_32_t<true>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_uint_32_concurrent::val", native_function_t<>::val(&lake_uint_32_t<true>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_int_64_concurrent::val", native_function_t<>::val(&lake_int_64_t<true>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_uint_64_concurrent::val", native_function_t<>::val(&lake_uint_64_t<true>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_float_32_concurrent::val", native_function_t<>::val(&lake_float_32_t<true>::val__));
	}
};
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update("strange::lake_float_64_concurrent::val", native_function_t<>::val(&lake_float_64_t<true>::val__));
	}
};
