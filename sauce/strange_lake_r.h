...
public:
	...
	{
		static cat_a<> CAT = cat_t<>::val(1, "strange::lake_" + number_u<_primitive_>::category());
		return CAT;
	}
...
public:
	...
	static inline void share(shoal_a<>& shoal)
	{
		shoal.update_string(type().to_string() + "::val", native_function_t<>::val(&lake_t<_primitive_, _concurrent_>::val__));
	}
};
