...
namespace strange {
    ...
    private:
      ...
      { return value_.reference__( ); }
    	...
    	friend inline bool check_(const number_data_a<___1___>& value);
    ...
    public:
    	...
    	explicit inline number_data_a(bool reference)
    	...
    	inline number_data_a(const number_data_a& other, bool reference)
    	...
    	inline number_data_a(number_data_a&& other, bool reference)
    	...
    	explicit inline number_data_a(const std::shared_ptr<___TTT___>& handle, bool reference = false)
    	...
    	explicit inline number_data_a(___TTT___ value, bool reference = false)
    	...
    	inline number_data_a& operator=(const std::shared_ptr<___TTT___>& handle)
    	...
    	inline number_data_a& operator=(___TTT___ value)
    ...
    inline bool check_(const number_data_a<___1___>& value)
