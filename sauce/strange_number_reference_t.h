...
public: ___THING___
	...
	{
		static symbol_a<> TYPE = sym__("strange::number_reference");
		return TYPE;
	}
	...
	inline number_reference_t& operator+=(any_a<> const& thing)
	{
		if (!check_<number_a<>>(thing))
		{
			throw dis__("strange::number_reference += passed non-number");
		}
	...
	inline number_a<> self_divide_(number_a<> const& number)
	{
		...
		if (num == 0)
		{
			throw dis__("strange::number_reference self_divide division by zero");
		}
		_number /= num;
		return me_();
	}
	...
	inline number_a<> self_modulo_(number_a<> const& number)
	{
		...
		if (num == 0)
		{
			throw dis__("strange::number_reference self_modulo division by zero");
		}
	...
	inline any_a<> from_int_64(any_a<> const& range)
	{
		...
		{
			throw dis__("strange::number_reference::from_int_64 passed wrong type of thing");
		}
	...
	inline any_a<> from_uint_64(any_a<> const& range)
	{
		...
		{
			throw dis__("strange::number_reference::from_uint_64 passed wrong type of thing");
		}
	...
	inline any_a<> from_float_64(any_a<> const& range)
	{
		...
		{
			throw dis__("strange::number_reference::from_float_64 passed wrong type of thing");
		}
	...
	inline any_a<> less_than(any_a<> const& range) const
	{
		...
		if (!check_<number_a<>>(thing))
		{
			throw dis__("strange::number_reference::less_than passed non-number");
		}
	...
	inline any_a<> greater_than(any_a<> const& range) const
	{
		...
		if (!check_<number_a<>>(thing))
		{
			throw dis__("strange::number_reference::greater_than passed non-number");
		}
	...
	inline any_a<> less_or_equal(any_a<> const& range) const
	{
		...
		if (!check_<number_a<>>(thing))
		{
			throw dis__("strange::number_reference::less_or_equal passed non-number");
		}
	...
	inline any_a<> greater_or_equal(any_a<> const& range) const
	{
		...
		if (!check_<number_a<>>(thing))
		{
			throw dis__("strange::number_reference::greater_or_equal passed non-number");
		}
