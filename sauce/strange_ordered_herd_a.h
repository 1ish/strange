...
namespace strange {
    ...
    public:
    	...
    	explicit inline ordered_herd_a(std::shared_ptr<___TTT___> const& handle, bool reference)
    	...
    	explicit inline ordered_herd_a(std::shared_ptr<___TTT___> const& handle, bool reference) noexcept
    	...
    	explicit inline ordered_herd_a(std::shared_ptr<___TTT___>& handle, reference_tag)
    	...
    	explicit inline ordered_herd_a(std::shared_ptr<___TTT___>& handle, reference_tag) noexcept
