...
namespace strange {
    ...
    private:
      ...
      { return value_.mutate_it( ); }
    	...
    	friend inline bool check(random_access_const_iterator_data_a<___1___> const& value) noexcept;
    ...
    public:
    	...
    	inline random_access_const_iterator_data_a(random_access_const_iterator_data_a& other, reference_tag) noexcept
...

    	{
    		...
    		return random_access_const_iterator_data_a(other, reference_tag{});

    	}

    

    	inline random_access_const_iterator_data_a(random_access_const_iterator_data_a& other, duplicate_tag) noexcept
...

    	{
    		...
    		return random_access_const_iterator_data_a(other, duplicate_tag{});
...

    	{
...

    		{
    			...
    			throw dis("random_access_const_iterator_data_a constructor failed to cast from base to final");
    	...
    	explicit inline random_access_const_iterator_data_a(std::shared_ptr<___TTT___> const& handle, bool reference)
    	...
    	explicit inline random_access_const_iterator_data_a(std::shared_ptr<___TTT___> const& handle, bool reference) noexcept
    	...
    	explicit inline random_access_const_iterator_data_a(std::shared_ptr<___TTT___>& handle, reference_tag)
    	...
    	explicit inline random_access_const_iterator_data_a(std::shared_ptr<___TTT___>& handle, reference_tag) noexcept
...

    	{
...

    		{
    			...
    			throw dis("random_access_const_iterator_data_a assignment failed to cast from base to final");
    ...
    inline bool check(random_access_const_iterator_data_a<___1___> const& value) noexcept
    ...
    bool const random_access_const_iterator_data_a<___1___>::___share___ = []()
