...
namespace strange {
    ...
    private:
      ...
      { return value_.reference__( ); }
    	...
    	friend inline bool check_(random_access_const_iterator_data_a<___1___> const& value);
    ...
    public:
    	...
    	explicit inline random_access_const_iterator_data_a(bool reference)
    	...
    	inline random_access_const_iterator_data_a(random_access_const_iterator_data_a const& other, bool reference)
    	...
    	inline random_access_const_iterator_data_a(random_access_const_iterator_data_a&& other, bool reference)
    	...
    	explicit inline random_access_const_iterator_data_a(___TTT___ value, bool reference = false)
    	...
    	inline random_access_const_iterator_data_a& operator=(___TTT___ value)
    ...
    inline bool check_(random_access_const_iterator_data_a<___1___> const& value)
