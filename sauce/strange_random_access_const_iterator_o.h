#ifndef COM_ONEISH_STRANGE_RANDOM_ACCESS_CONST_ITERATOR_O_H
#define COM_ONEISH_STRANGE_RANDOM_ACCESS_CONST_ITERATOR_O_H
...
public:
	...
	{
		static cat_a<> CAT = cat_t<>::val_(sym("strange::random_access_const_iterator"));
		return CAT;
	}
