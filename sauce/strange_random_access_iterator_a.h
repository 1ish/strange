...
namespace strange {
    ...
    private:
    	...
    	template <typename ___TTT___>
    	friend inline bool check_(random_access_iterator_a<> const& value) noexcept;
    ...
    public:
    	...
    	explicit inline random_access_iterator_a(bool reference) noexcept
    	...
    	inline random_access_iterator_a(random_access_iterator_a&& other, bool reference) noexcept
    ...
    #else
    	template <typename ___TTT___>
    	explicit inline random_access_iterator_a(std::shared_ptr<___TTT___> const& handle, bool reference = false) noexcept
    		: ___derived___(handle, reference)
    	{
    	...
    	explicit inline random_access_iterator_a(___TTT___ value, bool reference = false) noexcept
    ...
    template <typename ___TTT___>
    inline bool check_(random_access_iterator_a<> const& value) noexcept
    {
