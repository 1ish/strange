...
namespace strange {
    ...
    public:
    	...
    	inline random_access_iterator_a(random_access_iterator_a& other, reference_tag) noexcept
...

    	{
    		...
    		return random_access_iterator_a(other, reference_tag{});

    	}

    

    	inline random_access_iterator_a(random_access_iterator_a& other, duplicate_tag) noexcept
...

    	{
    		...
    		return random_access_iterator_a(other, duplicate_tag{});
...

    	{
...

    		{
    			...
    			throw dis("random_access_iterator_a constructor failed to cast from base to ddderived");
    	...
    	explicit inline random_access_iterator_a(std::shared_ptr<___TTT___> const& handle, bool reference)
    	...
    	explicit inline random_access_iterator_a(std::shared_ptr<___TTT___> const& handle, bool reference) noexcept
    	...
    	explicit inline random_access_iterator_a(std::shared_ptr<___TTT___>& handle, reference_tag)
    	...
    	explicit inline random_access_iterator_a(std::shared_ptr<___TTT___>& handle, reference_tag) noexcept
...

    	{
...

    		{
    			...
    			throw dis("random_access_iterator_a assignment failed to cast from base to ddderived");
    ...
    inline bool check(random_access_iterator_a<> const& value) noexcept
