...
namespace strange {
    ...
    public:
    	...
    	explicit inline squad_a(std::shared_ptr<___TTT___> const& handle, bool reference)
    	...
    	explicit inline squad_a(std::shared_ptr<___TTT___> const& handle, bool reference) noexcept
    ...
    bool const squad_a<___1___>::___share___ = []()
