...
namespace strange {
    ...
    public:
    	...
    	explicit inline unordered_herd_a(bool reference) noexcept
    	...
    	inline unordered_herd_a(unordered_herd_a&& other, bool reference) noexcept
    	...
    	explicit inline unordered_herd_a(std::shared_ptr<___TTT___> const& handle, bool reference = false)
    	...
    	explicit inline unordered_herd_a(std::shared_ptr<___TTT___> const& handle, bool reference = false) noexcept
    	...
    	explicit inline unordered_herd_a(___TTT___ value, bool reference = false) noexcept
