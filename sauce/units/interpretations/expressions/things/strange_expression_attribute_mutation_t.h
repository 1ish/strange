...
public:
	...
	{
		return expression_t<___ego___>::template create_expression<expression_attribute_mutation_t<___ego___>>(list);
	}
	...
	{
		shoal.update(sym("strange::expression_attribute_mutation::create"), native_function::create(&expression_attribute_mutation_t<>::create__));
	}
