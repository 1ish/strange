...
public:
	...
	{
		shoal.update(sym("strange::expression_function::create"), native_function::create(&expression_function_t<>::create__));
		shoal.update(sym("function!"), native_function::create(&expression_function_t<>::create__));
	}
